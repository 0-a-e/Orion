...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult postVisitDirectory(Object obj, IOException iOException) {
        return postVisitDirectory(Trace$$ExternalSyntheticApiModelOutline0.m(obj), iOException);
    }

    public /* bridge */ /* synthetic */ FileVisitResult preVisitDirectory(Object obj, BasicFileAttributes basicFileAttributes) {
        return preVisitDirectory(Trace$$ExternalSyntheticApiModelOutline0.m(obj), basicFileAttributes);
    }

    public /* bridge */ /* synthetic */ FileVisitResult visitFile(Object obj, BasicFileAttributes basicFileAttributes) {
        return visitFile(Trace$$ExternalSyntheticApiModelOutline0.m(obj), basicFileAttributes);
    }

    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(Trace$$ExternalSyntheticApiModelOutline0.m(obj), iOException);
    }
    ...
    public FileVisitResult preVisitDirectory(Path path, BasicFileAttributes basicFileAttributes) {
        ...
        if (function2 != null && (m = Trace$$ExternalSyntheticApiModelOutline0.m((Object) function2.invoke(path, basicFileAttributes))) != null) {
            return m;
        }
    ...
    public FileVisitResult visitFile(Path path, BasicFileAttributes basicFileAttributes) {
        FileVisitResult m;
        Intrinsics.checkNotNullParameter(path, TransferTable.COLUMN_FILE);
        Intrinsics.checkNotNullParameter(basicFileAttributes, "attrs");
    ...
    public FileVisitResult visitFileFailed(Path path, IOException iOException) {
        ...
        if (function2 != null && (m = Trace$$ExternalSyntheticApiModelOutline0.m((Object) function2.invoke(path, iOException))) != null) {
            return m;
        }
