    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (i5 + 2 < i6) {
            ...
            for (int i9 = 0; i9 < min; i9++) {
                int i10 = i5 + 2;
                i5 += 3;
                byte b = ((bArr3[i5 + 1] & 255) << 8) | ((bArr3[i5] & 255) << 16) | (bArr3[i10] & 255);
                bArr4[i8] = access$getBase64UrlEncodeMap$p[b >>> 18];
                bArr4[i8 + 1] = access$getBase64UrlEncodeMap$p[(b >>> 12) & 63];
                int i11 = i8 + 3;
                bArr4[i8 + 2] = access$getBase64UrlEncodeMap$p[(b >>> 6) & 63];
                i8 += 4;
                bArr4[i11] = access$getBase64UrlEncodeMap$p[b & 63];
            }
            if (min == i7 && i5 != i6) {
                int i12 = i8 + 1;
