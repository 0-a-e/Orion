...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m7112constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m7123setVurrAj0(r0, i, r2.m7110unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m7191constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m7202setVXSXFK8(r0, i, r2.m7189unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m7270constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m7281setk8EXiF4(r0, i, r2.m7268unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m7375constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m7386set01HTLdE(r0, i, r2.m7373unboximpl());
            i++;
        }
        return r0;
    }
