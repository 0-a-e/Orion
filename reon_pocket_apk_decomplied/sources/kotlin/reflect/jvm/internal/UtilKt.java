...
public final class UtilKt {
    ...
    private static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) {
        ...
        for (Annotation annotationClass : iterable) {
            if (Intrinsics.areEqual((Object) JvmClassMappingKt.getJavaClass(JvmClassMappingKt.getAnnotationClass(annotationClass)).getSimpleName(), (Object) TextFieldImplKt.ContainerId)) {
                Collection arrayList = new ArrayList();
    ...
    public static final Object defaultPrimitiveValue(Type type) {
        Intrinsics.checkNotNullParameter(type, TransferTable.COLUMN_TYPE);
