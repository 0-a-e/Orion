    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m7042constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m7042constructorimpl(Unit.INSTANCE);
        if (Result.m7049isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m8585successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m8583closedJP2dKIU(Result.m7045exceptionOrNullimpl(obj2));
        }
