...
public final class DelayKt {
    ...
    public static final Object m8548delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m8549toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m8549toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m8409isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m8393getInWholeMillisecondsimpl(Duration.m8411plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
