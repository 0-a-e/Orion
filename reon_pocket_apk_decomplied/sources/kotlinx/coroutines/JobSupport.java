...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x0094, code lost:
        if (tryWaitForChild(r1, r8, r9) == false) goto L_0x0099;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r8, java.lang.Object r9) {
        ...
        L_0x001d:
            ...
            r3.<init>()
            monitor-enter(r1)
            boolean r4 = r1.isCompleting()     // Catch:{ all -> 0x009e }
            if (r4 == 0) goto L_0x002f
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x009e }
            monitor-exit(r1)
            return r8
        L_0x002f:
            r4 = 1
            r1.setCompleting(r4)     // Catch:{ all -> 0x009e }
            if (r1 == r8) goto L_0x0045
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = _state$volatile$FU     // Catch:{ all -> 0x009e }
            boolean r5 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r5, r7, r8, r1)     // Catch:{ all -> 0x009e }
            if (r5 != 0) goto L_0x0045
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x009e }
            monitor-exit(r1)
            return r8
        L_0x0045:
            boolean r5 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x009e }
            if (r5 == 0) goto L_0x0059
            boolean r5 = r1.isSealed()     // Catch:{ all -> 0x009e }
            r5 = r5 ^ r4
            if (r5 == 0) goto L_0x0053
            goto L_0x0059
        L_0x0053:
            java.lang.AssertionError r8 = new java.lang.AssertionError     // Catch:{ all -> 0x009e }
            r8.<init>()     // Catch:{ all -> 0x009e }
            throw r8     // Catch:{ all -> 0x009e }
        L_0x0059:
            boolean r5 = r1.isCancelling()     // Catch:{ all -> 0x009e }
            boolean r6 = r9 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x009e }
            if (r6 == 0) goto L_0x0065
            r6 = r9
            kotlinx.coroutines.CompletedExceptionally r6 = (kotlinx.coroutines.CompletedExceptionally) r6     // Catch:{ all -> 0x009e }
            goto L_0x0066
        L_0x0065:
            r6 = r2
        L_0x0066:
            if (r6 == 0) goto L_0x006d
            java.lang.Throwable r6 = r6.cause     // Catch:{ all -> 0x009e }
            r1.addExceptionLocked(r6)     // Catch:{ all -> 0x009e }
        L_0x006d:
            java.lang.Throwable r6 = r1.getRootCause()     // Catch:{ all -> 0x009e }
            r4 = r4 ^ r5
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r4)     // Catch:{ all -> 0x009e }
            r5.getClass()     // Catch:{ all -> 0x009e }
            if (r4 == 0) goto L_0x007c
            r2 = r6
        L_0x007c:
            r3.element = r2     // Catch:{ all -> 0x009e }
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x009e }
            monitor-exit(r1)
            T r2 = r3.element
            java.lang.Throwable r2 = (java.lang.Throwable) r2
