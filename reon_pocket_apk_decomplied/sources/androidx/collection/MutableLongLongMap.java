...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final void plusAssign(LongLongMap longLongMap) {
        Intrinsics.checkNotNullParameter(longLongMap, Constants.MessagePayloadKeys.FROM);
        putAll(longLongMap);
    }
    ...
    public final void putAll(LongLongMap longLongMap) {
        ...
        Intrinsics.checkNotNullParameter(longLongMap2, Constants.MessagePayloadKeys.FROM);
