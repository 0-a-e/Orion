...
final class NavigationRailKt$NavigationRailItem$2$indicator$1$1$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    final /* synthetic */ State<Float> $animationProgress;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NavigationRailKt$NavigationRailItem$2$indicator$1$1$1(State<Float> state) {
        super(1);
