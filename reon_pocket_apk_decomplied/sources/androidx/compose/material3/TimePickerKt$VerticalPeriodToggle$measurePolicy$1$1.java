...
final class TimePickerKt$VerticalPeriodToggle$measurePolicy$1$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2496measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "Spacer")) {
                final Placeable r1 = measurable.m5368measureBRTryo0(Constraints.m6517copyZbe2FdA$default(j, 0, 0, 0, measureScope.m6545roundToPx0680j_4(TimePickerTokens.INSTANCE.m3186getPeriodSelectorOutlineWidthD9Ej5fM()), 3, (Object) null));
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    arrayList2.add(((Measurable) list3.get(i3)).m5368measureBRTryo0(Constraints.m6517copyZbe2FdA$default(j, 0, 0, 0, Constraints.m6525getMaxHeightimpl(j) / 2, 3, (Object) null)));
                }
                ...
                return MeasureScope.CC.layout$default(measureScope, Constraints.m6526getMaxWidthimpl(j), Constraints.m6525getMaxHeightimpl(j), (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
                    ...
                    public final void invoke(Placeable.PlacementScope placementScope) {
                        ...
                        Placeable.PlacementScope.place$default(placementScope, list4.get(1), 0, list4.get(0).getHeight(), 0.0f, 4, (Object) null);
                        Placeable.PlacementScope.place$default(placementScope, r1, 0, list4.get(0).getHeight() - (r1.getHeight() / 2), 0.0f, 4, (Object) null);
                    }
                }, 4, (Object) null);
            }
