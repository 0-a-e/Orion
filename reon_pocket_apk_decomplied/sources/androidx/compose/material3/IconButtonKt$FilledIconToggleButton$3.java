...
final class IconButtonKt$FilledIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C335@16347L152:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier r9 = SizeKt.m742size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m2901getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1822112194, "C339@16484L9:IconButton.kt#uh7d8r");
