...
final class SliderDefaults$Track$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SliderDefaults$Track$6(SliderDefaults sliderDefaults, RangeSliderState rangeSliderState, Modifier modifier, SliderColors sliderColors, boolean z, int i, int i2) {
        super(2);
