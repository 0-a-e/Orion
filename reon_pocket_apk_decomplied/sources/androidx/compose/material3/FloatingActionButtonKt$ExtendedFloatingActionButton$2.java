...
final class FloatingActionButtonKt$ExtendedFloatingActionButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    FloatingActionButtonKt$ExtendedFloatingActionButton$2(Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C282@13999L316:FloatingActionButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(398457247, i, -1, "androidx.compose.material3.ExtendedFloatingActionButton.<anonymous> (FloatingActionButton.kt:282)");
            }
            Modifier r11 = PaddingKt.m672paddingVpY3zN4$default(SizeKt.m746sizeInqDBjuR0$default(Modifier.Companion, FloatingActionButtonKt.ExtendedFabMinimumWidth, 0.0f, 0.0f, 0.0f, 14, (Object) null), FloatingActionButtonKt.ExtendedFabTextPadding, 0.0f, 2, (Object) null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(r11);
