...
final class ComposableSingletons$SnackbarHostKt$lambda1$1 extends Lambda implements Function3<SnackbarData, Composer, Integer, Unit> {
    ...
    public final void invoke(SnackbarData snackbarData, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer2, "C223@9306L12:SnackbarHost.kt#uh7d8r");
        if ((i & 6) == 0) {
            i2 = i | (composer2.changed((Object) snackbarData) ? 4 : 2);
        } else {
        ...
        if ((i2 & 19) != 18 || !composer.getSkipping()) {
            ...
            SnackbarKt.m2219SnackbarsDKtq54(snackbarData, (Modifier) null, false, (Shape) null, 0, 0, 0, 0, 0, composer, i2 & 14, 510);
            if (ComposerKt.isTraceInProgress()) {
