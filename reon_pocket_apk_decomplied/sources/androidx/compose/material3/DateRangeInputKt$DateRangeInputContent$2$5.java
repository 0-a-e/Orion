...
final class DateRangeInputKt$DateRangeInputContent$2$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C100@4370L94,99@4301L164:DateRangeInput.kt#uh7d8r");
        if ((i2 & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(911487285, i2, -1, "androidx.compose.material3.DateRangeInputContent.<anonymous>.<anonymous> (DateRangeInput.kt:99)");
            }
            String str = this.$endRangeText;
            Modifier modifier = Modifier.Companion;
            composer2.startReplaceableGroup(-2126786279);
