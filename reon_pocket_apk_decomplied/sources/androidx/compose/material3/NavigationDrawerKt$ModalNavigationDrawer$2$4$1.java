...
final class NavigationDrawerKt$ModalNavigationDrawer$2$4$1 extends Lambda implements Function1<Density, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return IntOffset.m6739boximpl(m2018invokeBjo55l4((Density) obj));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m2018invokeBjo55l4(Density density) {
        return IntOffsetKt.IntOffset(MathKt.roundToInt(this.$drawerState.requireOffset$material3_release()), 0);
    }
}
