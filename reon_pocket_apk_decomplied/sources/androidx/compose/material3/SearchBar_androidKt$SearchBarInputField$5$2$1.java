...
final class SearchBar_androidKt$SearchBarInputField$5$2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function2<Composer, Integer, Unit> $trailing;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SearchBar_androidKt$SearchBarInputField$5$2$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C490@22932L62:SearchBar.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1558904811, i, -1, "androidx.compose.material3.SearchBarInputField.<anonymous>.<anonymous>.<anonymous> (SearchBar.android.kt:490)");
            }
            Modifier r9 = OffsetKt.m629offsetVpY3zN4$default(Modifier.Companion, Dp.m6614constructorimpl(-SearchBar_androidKt.SearchBarIconOffsetX), 0.0f, 2, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 643342354, "C490@22982L10:SearchBar.android.kt#uh7d8r");
