...
final class BasicTooltip_androidKt$TooltipPopup$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function2<Composer, Integer, Unit> $content;
    final /* synthetic */ String $tooltipDescription;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BasicTooltip_androidKt$TooltipPopup$2(String str, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C141@5268L116,140@5221L187:BasicTooltip.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(282408040, i, -1, "androidx.compose.material3.TooltipPopup.<anonymous> (BasicTooltip.android.kt:140)");
            }
            Modifier modifier = Modifier.Companion;
            composer.startReplaceableGroup(1706937961);
            ComposerKt.sourceInformation(composer, "CC(remember):BasicTooltip.android.kt#9igjgp");
            boolean changed = composer.changed((Object) this.$tooltipDescription);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1913931381, "C145@5397L9:BasicTooltip.android.kt#uh7d8r");
