...
final class DatePickerKt$Day$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DatePickerKt$Day$2(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C1971@85536L275:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2031780827, i, -1, "androidx.compose.material3.Day.<anonymous> (DatePicker.kt:1971)");
            }
            Modifier r9 = SizeKt.m736requiredSizeVpY3zN4(Modifier.Companion, DatePickerModalTokens.INSTANCE.m2789getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m2788getDateStateLayerHeightD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -806739671, "C1978@85792L9:DatePicker.kt#uh7d8r");
