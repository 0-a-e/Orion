...
final class IconButtonKt$OutlinedIconButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$OutlinedIconButton$3(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C464@22777L154:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -369021930, "C468@22916L9:IconButton.kt#uh7d8r");
