...
final class DateRangePickerStateImpl$Companion$Saver$2 extends Lambda implements Function1<List, DateRangePickerStateImpl> {
    ...
    DateRangePickerStateImpl$Companion$Saver$2(SelectableDates selectableDates, Locale locale) {
        super(1);
    ...
    public final DateRangePickerStateImpl invoke(List<? extends Object> list) {
        ...
        return new DateRangePickerStateImpl((Long) list.get(0), (Long) list.get(1), (Long) list.get(2), intRange, DisplayMode.m1807constructorimpl(((Integer) obj3).intValue()), this.$selectableDates, this.$locale, (DefaultConstructorMarker) null);
    }
}
