...
final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C198@8313L151:TextFieldImpl.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2124779163, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:198)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1425715941, "C200@8431L11:TextFieldImpl.kt#uh7d8r");
