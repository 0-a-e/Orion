...
final class ComposableSingletons$TimePickerKt$lambda1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C1118@46712L40,1118@46700L53:TimePicker.kt#uh7d8r");
        if ((i2 & 17) != 16 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1425358052, i2, -1, "androidx.compose.material3.ComposableSingletons$TimePickerKt.lambda-1.<anonymous> (TimePicker.kt:1118)");
            }
            Strings.Companion companion = Strings.Companion;
            TextKt.m2456Text4IGK_g(Strings_androidKt.m2293getStringNWtq28(Strings.m2224constructorimpl(R.string.m3c_time_picker_am), composer2, 0), (Modifier) null, 0, 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer, 0, 0, 131070);
            if (ComposerKt.isTraceInProgress()) {
