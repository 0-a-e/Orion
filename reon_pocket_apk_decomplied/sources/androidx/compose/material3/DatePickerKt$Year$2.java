...
final class DatePickerKt$Year$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DatePickerKt$Year$2(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C2117@91715L110:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1573188346, i, -1, "androidx.compose.material3.Year.<anonymous> (DatePicker.kt:2117)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 873758912, "C2118@91806L9:DatePicker.kt#uh7d8r");
