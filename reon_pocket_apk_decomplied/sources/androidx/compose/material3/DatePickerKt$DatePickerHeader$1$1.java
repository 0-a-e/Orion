...
final class DatePickerKt$DatePickerHeader$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DatePickerKt$DatePickerHeader$1$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C1614@71978L93:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1936268514, i, -1, "androidx.compose.material3.DatePickerHeader.<anonymous>.<anonymous> (DatePicker.kt:1614)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1465500517, "C1615@72046L7:DatePicker.kt#uh7d8r");
