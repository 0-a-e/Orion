...
final class IconButtonKt$FilledTonalIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C399@19596L157:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier r9 = SizeKt.m742size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m2917getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 919448388, "C403@19738L9:IconButton.kt#uh7d8r");
