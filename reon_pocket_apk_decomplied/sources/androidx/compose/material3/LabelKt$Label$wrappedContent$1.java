...
final class LabelKt$Label$wrappedContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    LabelKt$Label$wrappedContent$1(MutableState<LayoutCoordinates> mutableState, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C89@3716L21,88@3658L123:Label.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1950723216, i, -1, "androidx.compose.material3.Label.<anonymous> (Label.kt:88)");
            }
            Modifier modifier = Modifier.Companion;
            composer.startReplaceableGroup(1482637652);
            ComposerKt.sourceInformation(composer, "CC(remember):Label.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -594506845, "C91@3762L9:Label.kt#uh7d8r");
