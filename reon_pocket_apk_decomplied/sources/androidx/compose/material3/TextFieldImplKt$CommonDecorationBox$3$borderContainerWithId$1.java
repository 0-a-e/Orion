...
final class TextFieldImplKt$CommonDecorationBox$3$borderContainerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C224@9418L302:TextFieldImpl.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1902535592, i, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:224)");
            }
            Modifier r9 = OutlinedTextFieldKt.m2050outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId), this.$labelSize.getValue().m3636unboximpl(), this.$contentPadding);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1425717197, "C230@9687L11:TextFieldImpl.kt#uh7d8r");
