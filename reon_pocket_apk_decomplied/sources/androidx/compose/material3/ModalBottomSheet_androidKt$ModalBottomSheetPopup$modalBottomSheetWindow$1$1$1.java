...
final class ModalBottomSheet_androidKt$ModalBottomSheetPopup$modalBottomSheetWindow$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        Modifier modifier;
        ComposerKt.sourceInformation(composer, "C452@19656L568:ModalBottomSheet.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-114385661, i, -1, "androidx.compose.material3.ModalBottomSheetPopup.<anonymous>.<anonymous>.<anonymous> (ModalBottomSheet.android.kt:452)");
            }
            Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SemanticsModifierKt.semantics$default(Modifier.Companion, false, AnonymousClass1.INSTANCE, 1, (Object) null), this.$windowInsets);
            if (Build.VERSION.SDK_INT >= 33) {
                modifier = WindowInsetsPadding_androidKt.imePadding(Modifier.Companion);
            } else {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 321878204, "C463@20186L16:ModalBottomSheet.android.kt#uh7d8r");
            ModalBottomSheet_androidKt.ModalBottomSheetPopup$lambda$8(state).invoke(composer, 0);
