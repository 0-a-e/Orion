...
final class ChipKt$InputChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ChipKt$InputChip$2(float f, Shape shape, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C607@30964L148,606@30909L311:Chip.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1154227507, i, -1, "androidx.compose.material3.InputChip.<anonymous> (Chip.kt:606)");
            }
            Modifier modifier = Modifier.Companion;
            composer.startReplaceableGroup(946467138);
            ComposerKt.sourceInformation(composer, "CC(remember):Chip.kt#9igjgp");
            boolean changed = composer.changed(this.$avatarOpacity) | composer.changed((Object) this.$avatarShape);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1294405811, "C614@31198L8:Chip.kt#uh7d8r");
