...
final class TimePickerKt$TimeSelector$2$1 extends Lambda implements Function0<Unit> {
    ...
    TimePickerKt$TimeSelector$2$1(int i, TimePickerState timePickerState, CoroutineScope coroutineScope) {
        super(0);
        this.$selection = i;
    ...
    public final void invoke() {
        if (!Selection.m2164equalsimpl0(this.$selection, this.$state.m2507getSelectionJiIwxys$material3_release())) {
            this.$state.m2510setSelectioniHAOin8$material3_release(this.$selection);
