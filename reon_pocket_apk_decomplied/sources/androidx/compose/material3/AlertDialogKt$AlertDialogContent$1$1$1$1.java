...
final class AlertDialogKt$AlertDialogContent$1$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AlertDialogKt$AlertDialogContent$1$1$1$1(ColumnScope columnScope, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C64@2275L229:AlertDialog.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 691155737, "C69@2476L6:AlertDialog.kt#uh7d8r");
