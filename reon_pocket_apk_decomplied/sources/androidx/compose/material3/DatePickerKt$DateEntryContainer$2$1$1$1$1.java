...
final class DatePickerKt$DateEntryContainer$2$1$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DatePickerKt$DateEntryContainer$2$1$1$1$1(RowScope rowScope, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C1331@59864L110:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-962031352, i, -1, "androidx.compose.material3.DateEntryContainer.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (DatePicker.kt:1331)");
            }
            Modifier weight$default = RowScope.CC.weight$default(this.$this_Row, Modifier.Companion, 1.0f, false, 2, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 2128822724, "C1332@59934L10:DatePicker.kt#uh7d8r");
