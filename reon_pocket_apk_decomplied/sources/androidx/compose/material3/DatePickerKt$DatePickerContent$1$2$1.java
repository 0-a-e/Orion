...
final class DatePickerKt$DatePickerContent$1$2$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CoroutineScope $coroutineScope;
    final /* synthetic */ LazyListState $monthsListState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DatePickerKt$DatePickerContent$1$2$1(CoroutineScope coroutineScope, LazyListState lazyListState) {
        super(0);
