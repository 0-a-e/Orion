...
final class BottomSheetScaffoldKt$StandardBottomSheet$3$1$1$1$1$3 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ SheetState $this_with;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BottomSheetScaffoldKt$StandardBottomSheet$3$1$1$1$1$3(CoroutineScope coroutineScope, SheetState sheetState) {
        super(0);
