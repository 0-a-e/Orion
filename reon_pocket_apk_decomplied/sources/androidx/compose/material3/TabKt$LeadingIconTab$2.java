...
final class TabKt$LeadingIconTab$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    TabKt$LeadingIconTab$2(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(PaddingKt.m672paddingVpY3zN4$default(SelectableKt.m1000selectableO2vRcR0(SizeKt.m728height3ABfNKs(this.$modifier, TabKt.SmallTabHeight), this.$selected, this.$interactionSource, this.$ripple, this.$enabled, Role.m5857boximpl(Role.Companion.m5870getTabo7Vup1c()), this.$onClick), TabKt.getHorizontalTextPadding(), 0.0f, 2, (Object) null), 0.0f, 1, (Object) null);
            ...
            SpacerKt.Spacer(SizeKt.m739requiredWidth3ABfNKs(Modifier.Companion, TabKt.TextDistanceFromLeadingIcon), composer2, 6);
