...
final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ListItemKt$ListItem$decoratedTrailingContent$1$1(ListItemColors listItemColors, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C130@5700L297:ListItem.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1512306332, i, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:130)");
            }
            Modifier r10 = PaddingKt.m674paddingqDBjuR0$default(Modifier.Companion, ListItemKt.getTrailingContentStartPadding(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 2011888960, "C131@5777L206:ListItem.kt#uh7d8r");
            ListItemKt.m1945ProvideTextStyleFromToken3JVO9M(listItemColors.m1941trailingIconColorvNxB06k$material3_release(true), ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), function2, composer, 48);
