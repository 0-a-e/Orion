...
final class SearchBar_androidKt$SearchBarInputField$5$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function2<Composer, Integer, Unit> $leading;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SearchBar_androidKt$SearchBarInputField$5$1$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C487@22765L60:SearchBar.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1030845367, i, -1, "androidx.compose.material3.SearchBarInputField.<anonymous>.<anonymous>.<anonymous> (SearchBar.android.kt:487)");
            }
            Modifier r9 = OffsetKt.m629offsetVpY3zN4$default(Modifier.Companion, SearchBar_androidKt.SearchBarIconOffsetX, 0.0f, 2, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 643342186, "C487@22814L9:SearchBar.android.kt#uh7d8r");
