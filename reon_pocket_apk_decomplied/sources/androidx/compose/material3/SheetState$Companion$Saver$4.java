...
final class SheetState$Companion$Saver$4 extends Lambda implements Function1<SheetValue, SheetState> {
    final /* synthetic */ Function1<SheetValue, Boolean> $confirmValueChange;
    final /* synthetic */ boolean $skipPartiallyExpanded;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SheetState$Companion$Saver$4(boolean z, Function1<? super SheetValue, Boolean> function1) {
        super(1);
