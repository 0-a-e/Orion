...
final class SurfaceKt$Surface$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C119@5729L139,*124@5963L7,115@5593L707:Surface.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-70914509, i, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:115)");
            }
            Modifier modifier = this.$modifier;
            Shape shape = this.$shape;
            long r5 = SurfaceKt.m2310surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, 0);
            BorderStroke borderStroke = this.$border;
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = composer.consume(CompositionLocalsKt.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd(composer);
            Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(SurfaceKt.m2309surfaceXOJAsU(modifier, shape, r5, borderStroke, ((Density) consume).m6550toPx0680j_4(this.$shadowElevation)), false, AnonymousClass2.INSTANCE), (Object) Unit.INSTANCE, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3((Continuation<? super AnonymousClass3>) null));
            ...
            Composer r52 = Updater.m3282constructorimpl(composer);
            Updater.m3289setimpl(r52, rememberBoxMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
            Updater.m3289setimpl(r52, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1301758687, "C133@6281L9:Surface.kt#uh7d8r");
