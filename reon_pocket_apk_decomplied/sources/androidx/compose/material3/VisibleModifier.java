...
final class VisibleModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult m2621measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Placeable r9 = measurable.m5368measureBRTryo0(j);
        if (!this.visible) {
            return MeasureScope.CC.layout$default(measureScope, 0, 0, (Map) null, VisibleModifier$measure$1.INSTANCE, 4, (Object) null);
        }
        return MeasureScope.CC.layout$default(measureScope, r9.getWidth(), r9.getHeight(), (Map) null, new VisibleModifier$measure$2(r9), 4, (Object) null);
    }
