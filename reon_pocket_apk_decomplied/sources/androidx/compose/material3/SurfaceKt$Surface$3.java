...
final class SurfaceKt$Surface$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SurfaceKt$Surface$3(Modifier modifier, Shape shape, long j, float f, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, boolean z, Function0<Unit> function0, float f2, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1279702876, i2, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:221)");
            }
            ...
            Modifier r1 = ClickableKt.m246clickableO2vRcR0$default(SurfaceKt.m2309surfaceXOJAsU(minimumInteractiveComponentSize, shape, r4, borderStroke, ((Density) consume).m6550toPx0680j_4(this.$shadowElevation)), this.$interactionSource, RippleKt.m1491rememberRipple9IZ8Weo(false, 0.0f, 0, composer, 0, 7), this.$enabled, (String) null, (Role) null, this.$onClick, 24, (Object) null);
