...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    TextFieldImplKt$CommonDecorationBox$3$decoratedPrefix$1(float f, long j, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C149@6292L285:TextFieldImpl.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1425713875, "C150@6365L190:TextFieldImpl.kt#uh7d8r");
            TextFieldImplKt.m2445DecorationKTwxG1Y(j, textStyle, function2, composer, 0, 0);
