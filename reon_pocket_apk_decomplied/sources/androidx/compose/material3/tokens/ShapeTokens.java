...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m1039RoundedCornerShape0680j_4(Dp.m6614constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m1039RoundedCornerShape0680j_4(Dp.m6614constructorimpl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m1039RoundedCornerShape0680j_4(Dp.m6614constructorimpl(f));
        float r1 = Dp.m6614constructorimpl(f);
        float r0 = Dp.m6614constructorimpl(f);
        float f2 = (float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        CornerExtraLargeTop = RoundedCornerShapeKt.m1040RoundedCornerShapea9UjIt4(r1, r0, Dp.m6614constructorimpl(f2), Dp.m6614constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m1039RoundedCornerShape0680j_4(Dp.m6614constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m1040RoundedCornerShapea9UjIt4(Dp.m6614constructorimpl(f3), Dp.m6614constructorimpl(f3), Dp.m6614constructorimpl(f2), Dp.m6614constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m1039RoundedCornerShape0680j_4(Dp.m6614constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m1040RoundedCornerShapea9UjIt4(Dp.m6614constructorimpl(f2), Dp.m6614constructorimpl(f4), Dp.m6614constructorimpl(f4), Dp.m6614constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m1040RoundedCornerShapea9UjIt4(Dp.m6614constructorimpl(f4), Dp.m6614constructorimpl(f4), Dp.m6614constructorimpl(f2), Dp.m6614constructorimpl(f2));
    }
}
