...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m6614constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m6614constructorimpl(f);
        ListItemTrailingIconSize = Dp.m6614constructorimpl(f);
    }
    ...
    public final float m2962getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2963getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2964getListItemTrailingIconSizeD9Ej5fM() {
