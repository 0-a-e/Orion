...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m6614constructorimpl((float) 4.0d);
    public static final float DockedDragHandleOpacity = 0.4f;
    private static final float DockedDragHandleWidth = Dp.m6614constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2818getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2818getLevel1D9Ej5fM();
    ...
    public final float m3126getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m3127getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m3128getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m3129getDockedStandardContainerElevationD9Ej5fM() {
