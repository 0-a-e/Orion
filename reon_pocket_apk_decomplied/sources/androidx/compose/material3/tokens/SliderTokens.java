...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2817getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2818getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2817getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m6614constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m6614constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m6614constructorimpl((float) 2.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2817getLevel0D9Ej5fM();
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m6614constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m6614constructorimpl(f2);
        HandleWidth = Dp.m6614constructorimpl(f2);
        InactiveTrackHeight = Dp.m6614constructorimpl(f);
    }
    ...
    public final float m3130getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3131getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m3132getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m3133getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3134getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3135getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3136getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m3137getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m3139getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM  reason: not valid java name */
    public final float m3141getTrackElevationD9Ej5fM() {
    ...
    public final float m3138getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m3140getTickMarksContainerSizeD9Ej5fM() {
