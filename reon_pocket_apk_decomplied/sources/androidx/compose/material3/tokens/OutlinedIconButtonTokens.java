...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6614constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6614constructorimpl((float) 24.0d);
    ...
    public final float m3004getContainerSizeD9Ej5fM() {
    ...
    public final float m3005getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3006getUnselectedOutlineWidthD9Ej5fM() {
