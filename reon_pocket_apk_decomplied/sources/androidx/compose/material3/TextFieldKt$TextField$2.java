    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1859145987, i2, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:200)");
            }
            ...
            BasicTextFieldKt.BasicTextField(str4, (Function1<? super String, Unit>) function13, modifier3, z14, z15, textStyle3, keyboardOptions3, keyboardActions3, z16, i7, i8, visualTransformation5, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource5, brush2, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer, -288211827, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
                    int i2;
                    Composer composer2 = composer;
                    ComposerKt.sourceInformation(composer2, "C222@11393L743:TextField.kt#uh7d8r");
