...
final class ChipElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!Dp.m6619equalsimpl0(this.$animatable.getTargetValue().m6628unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    Interaction access$animateElevation$lambda$2 = ChipElevation.animateElevation$lambda$2(this.$lastInteraction$delegate);
                    this.label = 2;
        ...
        ChipElevation.animateElevation$lambda$3(this.$lastInteraction$delegate, this.$interaction);
        return Unit.INSTANCE;
    }
}
