...
final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C186@8468L10,187@8561L49,188@8623L152:NavigationRail.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ProvideContentColorTextStyleKt.m2082ProvideContentColorTextStyle3JVO9M(invoke$lambda$0(this.$colors.textColor$material3_release(this.$selected, this.$enabled, composer, 0)), TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composer, 6), NavigationRailTokens.INSTANCE.getLabelTextFont()), this.$label, composer, 0);
            if (ComposerKt.isTraceInProgress()) {
