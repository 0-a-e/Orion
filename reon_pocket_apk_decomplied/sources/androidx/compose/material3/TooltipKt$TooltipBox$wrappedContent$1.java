...
final class TooltipKt$TooltipBox$wrappedContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C133@5769L21,132@5711L123:Tooltip.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1130808188, i, -1, "androidx.compose.material3.TooltipBox.<anonymous> (Tooltip.kt:132)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -824895762, "C135@5815L9:Tooltip.kt#uh7d8r");
