...
final class TextFieldDefaults$TextFieldDecorationBox$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    TextFieldDefaults$TextFieldDecorationBox$1(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape) {
        super(2);
        this.$enabled = z;
        this.$isError = z2;
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C1029@57300L64:TextFieldDefaults.kt#uh7d8r");
