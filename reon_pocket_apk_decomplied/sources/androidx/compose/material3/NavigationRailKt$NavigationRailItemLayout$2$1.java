...
final class NavigationRailKt$NavigationRailItemLayout$2$1 implements MeasurePolicy {
    final /* synthetic */ boolean $alwaysShowLabel;
    final /* synthetic */ Function0<Float> $animationProgress;
    final /* synthetic */ Function2<Composer, Integer, Unit> $label;

    NavigationRailKt$NavigationRailItemLayout$2$1(Function0<Float> function0, Function2<? super Composer, ? super Integer, Unit> function2, boolean z) {
    ...
    public final MeasureResult m2037measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        float f;
        Object obj;
        Placeable placeable;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                ...
                float f2 = (float) 2;
                int width = r5.getWidth() + measureScope2.m6545roundToPx0680j_4(Dp.m6614constructorimpl(NavigationRailKt.IndicatorHorizontalPadding * f2));
                ...
                int height = r5.getHeight() + measureScope2.m6545roundToPx0680j_4(Dp.m6614constructorimpl(f * f2));
                int size2 = list.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), (Object) "indicatorRipple")) {
                        ...
                        placeable = null;
                        if (this.$label == null) {
                            return NavigationRailKt.m2035placeIconX9ElhV4(measureScope, r5, r6, r7, j);
                        }
                        Intrinsics.checkNotNull(placeable);
                        return NavigationRailKt.m2036placeLabelAndIconzUg2_y0(measureScope, placeable, r5, r6, r7, j, this.$alwaysShowLabel, floatValue);
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
