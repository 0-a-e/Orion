...
final class Tooltip_androidKt$PlainTooltip$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    Tooltip_androidKt$PlainTooltip$1(long j, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
        this.$contentColor = j;
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C90@3542L580:Tooltip.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m746sizeInqDBjuR0$default(modifier, TooltipKt.getTooltipMinWidth(), TooltipKt.getTooltipMinHeight(), TooltipKt.getPlainTooltipMaxWidth(), 0.0f, 8, (Object) null), TooltipKt.getPlainTooltipContentPadding());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 64550122, "C99@3858L10,101@3931L181:Tooltip.android.kt#uh7d8r");
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3806boximpl(j)), TextKt.getLocalTextStyle().provides(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composer, 6), PlainTooltipTokens.INSTANCE.getSupportingTextFont()))}, (Function2<? super Composer, ? super Integer, Unit>) function2, composer, 0);
