...
final class InterceptedKeyInputNode extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean m4644onInterceptKeyBeforeSoftKeyboardZmokQxo(KeyEvent keyEvent) {
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m4940boximpl(keyEvent)).booleanValue();
        }
        return false;
    }

    /* renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo  reason: not valid java name */
    public boolean m4645onPreInterceptKeyBeforeSoftKeyboardZmokQxo(KeyEvent keyEvent) {
