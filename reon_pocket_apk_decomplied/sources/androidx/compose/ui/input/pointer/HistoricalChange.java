...
public final class HistoricalChange {
    ...
    public final long m5039getPositionF1C5BW0() {
        return this.position;
    }

    /* renamed from: getOriginalEventPosition-F1C5BW0$ui_release  reason: not valid java name */
    public final long m5038getOriginalEventPositionF1C5BW0$ui_release() {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + Offset.m3570toStringimpl(this.position) + ')';
    }
}
