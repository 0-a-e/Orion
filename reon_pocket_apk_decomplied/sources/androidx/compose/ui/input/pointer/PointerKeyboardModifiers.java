...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m5179boximpl(int i) {
    ...
    public static boolean m5181equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).m5185unboximpl();
    }
    ...
    public int hashCode() {
        return m5183hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5184toStringimpl(this.packedValue);
    }
