...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        return !Offset.m3559equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m3578getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        return !Offset.m3559equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m3578getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long r0 = Offset.m3566minusMKHz9U(pointerInputChange.m5113getPositionF1C5BW0(), pointerInputChange.m5114getPreviousPositionF1C5BW0());
        return (z || !pointerInputChange.isConsumed()) ? r0 : Offset.Companion.m3578getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        if (!Offset.m3559equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m3578getZeroF1C5BW0())) {
            pointerInputChange.consume();
        }
    }
    ...
    public static final boolean m5056isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        long r0 = pointerInputChange.m5113getPositionF1C5BW0();
        float r3 = Offset.m3562getXimpl(r0);
        float r02 = Offset.m3563getYimpl(r0);
        return r3 < 0.0f || r3 > ((float) IntSize.m6790getWidthimpl(j)) || r02 < 0.0f || r02 > ((float) IntSize.m6789getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs  reason: not valid java name */
    public static final boolean m5057isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        if (!PointerType.m5189equalsimpl0(pointerInputChange.m5116getTypeT8wyACA(), PointerType.Companion.m5196getTouchT8wyACA())) {
            return m5056isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long r0 = pointerInputChange.m5113getPositionF1C5BW0();
        float r4 = Offset.m3562getXimpl(r0);
        float r02 = Offset.m3563getYimpl(r0);
        return r4 < (-Size.m3631getWidthimpl(j2)) || r4 > ((float) IntSize.m6790getWidthimpl(j)) + Size.m3631getWidthimpl(j2) || r02 < (-Size.m3628getHeightimpl(j2)) || r02 > ((float) IntSize.m6789getHeightimpl(j)) + Size.m3628getHeightimpl(j2);
    }
}
