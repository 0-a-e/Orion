...
public final class PointerIdArray {
    ...
    public final long m5241get_I2yYro(int i) {
        return PointerId.m5093constructorimpl(this.internalArray[i]);
    }

    /* renamed from: remove-0FcD4WY  reason: not valid java name */
    public final boolean m5242remove0FcD4WY(long j) {
        return remove(j);
    }
    ...
    public final boolean m5239add0FcD4WY(long j) {
        return add(j);
    }
    ...
    public final void m5243setDmW0f2w(int i, long j) {
        set(i, j);
    }
    ...
    public final boolean m5240contains0FcD4WY(long j) {
        return contains(j);
    }
