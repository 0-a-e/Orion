...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5790calculateMatrixGrdbGEg(T t) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m4058constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
        ...
        if (matrix2 == null || !Intrinsics.areEqual((Object) matrix, (Object) matrix2)) {
            AndroidMatrixConversions_androidKt.m3675setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m5789calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m5787invertToJiSxe2E(m5790calculateMatrixGrdbGEg(t), fArr);
