...
public interface WindowInfo {
    ...
    int m5841getKeyboardModifiersk7X9c1A();
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m5843getKeyboardModifiersk7X9c1A$annotations() {
        }

        /* renamed from: $default$getKeyboardModifiers-k7X9c1A  reason: not valid java name */
        public static int m5842$default$getKeyboardModifiersk7X9c1A(WindowInfo _this) {
            return WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().getValue().m5185unboximpl();
        }
    }
}
