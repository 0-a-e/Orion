...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m4120stampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
            return AndroidPathEffect_androidKt.m3700actualStampedPathEffect7aD1DOk(path, f, f2, i);
        }
    }
}
