...
public final class Stroke extends DrawStyle {
    ...
    public static final int DefaultCap = StrokeCap.Companion.m4230getButtKaPHkGw();
    /* access modifiers changed from: private */
    public static final int DefaultJoin = StrokeJoin.Companion.m4241getMiterLxFBmk8();
    ...
    public final int m4555getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m4556getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m4557getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m4558getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4226equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4236equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual((Object) this.pathEffect, (Object) stroke.pathEffect);
    }

    public int hashCode() {
        int floatToIntBits = ((((((Float.floatToIntBits(this.width) * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m4227hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4237hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect2 = this.pathEffect;
        return floatToIntBits + (pathEffect2 != null ? pathEffect2.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + StrokeCap.m4228toStringimpl(this.cap) + ", join=" + StrokeJoin.m4238toStringimpl(this.join) + ", pathEffect=" + this.pathEffect + ')';
    }
}
