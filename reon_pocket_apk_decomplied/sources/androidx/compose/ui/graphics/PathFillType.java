...
public final class PathFillType {
    ...
    public static final int EvenOdd = m4122constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int NonZero = m4122constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathFillType m4121boximpl(int i) {
    ...
    public static boolean m4123equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).m4127unboximpl();
    }
    ...
    public final /* synthetic */ int m4127unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m4129getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os  reason: not valid java name */
        public final int m4128getEvenOddRgk1Os() {
    ...
    public static String m4126toStringimpl(int i) {
        if (m4124equalsimpl0(i, NonZero)) {
            return "NonZero";
        }
        if (m4124equalsimpl0(i, EvenOdd)) {
            return "EvenOdd";
        }
        return "Unknown";
    }
