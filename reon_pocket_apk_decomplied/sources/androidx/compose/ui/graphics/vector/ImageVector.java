...
public final class ImageVector {
    ...
    public final float m4575getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m4574getDefaultHeightD9Ej5fM() {
    ...
    public final long m4577getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4576getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(java.lang.String r14, float r15, float r16, float r17, float r18, long r19, int r21, boolean r22, int r23, kotlin.jvm.internal.DefaultConstructorMarker r24) {
            ...
            L_0x0019:
                ...
                int r1 = r1.m3744getSrcIn0nO6VwU()
                r10 = r1
                goto L_0x0027
            L_0x0025:
                r10 = r21
        ...
        public /* synthetic */ Builder(java.lang.String r12, float r13, float r14, float r15, float r16, long r17, int r19, int r20, kotlin.jvm.internal.DefaultConstructorMarker r21) {
            ...
            L_0x0017:
                ...
                int r0 = r0.m3744getSrcIn0nO6VwU()
                r9 = r0
                goto L_0x0025
            L_0x0023:
                r9 = r19
        ...
        public static /* synthetic */ Builder m4578addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            int i5;
            int i6 = i4;
            ...
            return builder.m4579addPathoIyEayM(list, defaultFillType, str2, brush4, f9, brush3, f10, f12, defaultStrokeLineCap, i5, f13, f14, f8, f11);
        }

        /* renamed from: addPath-oIyEayM  reason: not valid java name */
        public final Builder m4579addPathoIyEayM(List<? extends PathNode> list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7) {
            ensureNotConsumed();
            List<VectorNode> children = getCurrentGroup().getChildren();
            VectorPath vectorPath = r1;
            VectorPath vectorPath2 = new VectorPath(str, list, i, brush, f, brush2, f2, f3, i2, i3, f4, f5, f6, f7, (DefaultConstructorMarker) null);
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.name, (Object) imageVector.name) && Dp.m6619equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m6619equalsimpl0(this.defaultHeight, imageVector.defaultHeight) && this.viewportWidth == imageVector.viewportWidth && this.viewportHeight == imageVector.viewportHeight && Intrinsics.areEqual((Object) this.root, (Object) imageVector.root) && Color.m3817equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m3715equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
    }

    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m6620hashCodeimpl(this.defaultWidth)) * 31) + Dp.m6620hashCodeimpl(this.defaultHeight)) * 31) + Float.floatToIntBits(this.viewportWidth)) * 31) + Float.floatToIntBits(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m3823hashCodeimpl(this.tintColor)) * 31) + BlendMode.m3716hashCodeimpl(this.tintBlendMode)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoMirror);
    }
}
