...
public final class Shadow {
    ...
    public static /* synthetic */ void m4196getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m4197getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m3578getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, (DefaultConstructorMarker) null);
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m4199getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m4200getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3817equalsimpl0(this.color, shadow.color) && Offset.m3559equalsimpl0(this.offset, shadow.offset) && this.blurRadius == shadow.blurRadius;
    }

    public int hashCode() {
        return (((Color.m3823hashCodeimpl(this.color) * 31) + Offset.m3564hashCodeimpl(this.offset)) * 31) + Float.floatToIntBits(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + Color.m3824toStringimpl(this.color) + ", offset=" + Offset.m3570toStringimpl(this.offset) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default  reason: not valid java name */
    public static /* synthetic */ Shadow m4195copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m4198copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m4198copyqcb84PM(long j, long j2, float f) {
