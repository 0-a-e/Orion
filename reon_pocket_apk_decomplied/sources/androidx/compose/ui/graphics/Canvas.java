...
public interface Canvas {
    ...
    void m3775clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m3776clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    void m3777clipRectmtrdDE(Rect rect, int i);

    /* renamed from: concat-58bKbWc  reason: not valid java name */
    void m3778concat58bKbWc(float[] fArr);
    ...
    void m3779drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I  reason: not valid java name */
    void m3780drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    void m3781drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    void m3782drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void m3783drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY  reason: not valid java name */
    void m3784drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void m3785drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m3790clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m3805getIntersectrtfAjoo();
                }
                canvas.m3777clipRectmtrdDE(rect, i);
                return;
            }
        ...
        public static void m3786$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            _this.m3776clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m3789clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 16) != 0) {
                    i = ClipOp.Companion.m3805getIntersectrtfAjoo();
                }
                canvas.m3776clipRectN_I0leg(f, f2, f3, f4, i);
                return;
            }
        ...
        public static /* synthetic */ void m3788clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m3805getIntersectrtfAjoo();
                }
                canvas.m3775clipPathmtrdDE(path, i);
                return;
            }
        ...
        public static /* synthetic */ void m3791drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj == null) {
                long r4 = (i & 2) != 0 ? IntOffset.Companion.m6758getZeronOccac() : j;
                long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
                canvas.m3781drawImageRectHPBpro0(imageBitmap, r4, IntSize, (i & 8) != 0 ? IntOffset.Companion.m6758getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
                return;
            }
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
        public static void m3794clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            CC.m3786$default$clipRectmtrdDE(canvas, rect, i);
        }
