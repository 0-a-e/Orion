...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader m4243createShaderuvyYCjk(long j) {
        long j2;
        if (OffsetKt.m3583isUnspecifiedk4lQ0M(this.center)) {
            j2 = SizeKt.m3641getCenteruvyYCjk(j);
        } else {
            j2 = OffsetKt.Offset(Offset.m3562getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3631getWidthimpl(j) : Offset.m3562getXimpl(this.center), Offset.m3563getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3628getHeightimpl(j) : Offset.m3563getYimpl(this.center));
        }
        return ShaderKt.m4193SweepGradientShader9KIMszo(j2, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Offset.m3559equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual((Object) this.colors, (Object) sweepGradient.colors) && Intrinsics.areEqual((Object) this.stops, (Object) sweepGradient.stops);
    }

    public int hashCode() {
        int r0 = ((Offset.m3564hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
