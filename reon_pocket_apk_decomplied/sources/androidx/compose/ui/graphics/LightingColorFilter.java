...
public final class LightingColorFilter extends ColorFilter {
    ...
    public final long m4053getMultiply0d7_KjU() {
        return this.multiply;
    }

    /* renamed from: getAdd-0d7_KjU  reason: not valid java name */
    public final long m4052getAdd0d7_KjU() {
        return this.add;
    }
    ...
    private LightingColorFilter(long j, long j2) {
        this(j, j2, AndroidColorFilter_androidKt.m3669actualLightingColorFilterOWjLjI(j, j2), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3817equalsimpl0(this.multiply, lightingColorFilter.multiply) && Color.m3817equalsimpl0(this.add, lightingColorFilter.add);
    }

    public int hashCode() {
        return (Color.m3823hashCodeimpl(this.multiply) * 31) + Color.m3823hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + Color.m3824toStringimpl(this.multiply) + ", add=" + Color.m3824toStringimpl(this.add) + ')';
    }
}
