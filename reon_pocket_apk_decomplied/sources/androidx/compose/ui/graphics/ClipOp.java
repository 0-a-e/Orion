...
public final class ClipOp {
    ...
    public static final int Difference = m3798constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Intersect = m3798constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ClipOp m3797boximpl(int i) {
        return new ClipOp(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3798constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3799equalsimpl(int i, Object obj) {
        return (obj instanceof ClipOp) && i == ((ClipOp) obj).m3803unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3800equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3801hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m3802toStringimpl(int i) {
        if (m3800equalsimpl0(i, Difference)) {
            return "Difference";
        }
        if (m3800equalsimpl0(i, Intersect)) {
            return "Intersect";
        }
        return "Unknown";
    }
