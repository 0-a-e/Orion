...
public final class CornerRadiusKt {
    ...
    public static final long m3548lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3537getXimpl(j), CornerRadius.m3537getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m3538getYimpl(j), CornerRadius.m3538getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        long floatToRawIntBits = (long) Float.floatToRawIntBits(f);
        return CornerRadius.m3531constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (floatToRawIntBits << 32));
    }
}
