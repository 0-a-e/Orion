...
public final class BiasAlignment implements Alignment {
    ...
    public long m3419alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        float f;
        float r0 = ((float) (IntSize.m6790getWidthimpl(j2) - IntSize.m6790getWidthimpl(j))) / 2.0f;
        float r3 = ((float) (IntSize.m6789getHeightimpl(j2) - IntSize.m6789getHeightimpl(j))) / 2.0f;
