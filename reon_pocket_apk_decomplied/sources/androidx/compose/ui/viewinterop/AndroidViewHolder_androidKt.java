...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int roundToInt = MathKt.roundToInt(Offset.m3562getXimpl(positionInRoot));
        int roundToInt2 = MathKt.roundToInt(Offset.m3563getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.Companion.m5005getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m5006getFlingWNlRxjI();
    }
}
