...
final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m5608hit1hIXUjU(NodeCoordinatorKt.m5645nextUntilhw7D004(this.$this_hit, this.$hitTestSource.m5643entityTypeOLwlOKw(), NodeKind.m5647constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}
