...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public long m5566calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long r0 = lookaheadDelegate.m5582getPositionnOccac();
        return Offset.m3567plusMKHz9U(OffsetKt.Offset((float) IntOffset.m6748getXimpl(r0), (float) IntOffset.m6749getYimpl(r0)), j);
    }
}
