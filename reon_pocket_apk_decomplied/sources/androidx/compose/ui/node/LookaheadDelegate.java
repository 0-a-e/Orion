...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public long m5582getPositionnOccac() {
        return this.position;
    }

    /* renamed from: setPosition--gyyYBs  reason: not valid java name */
    public void m5587setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5407setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            m5407setMeasuredSizeozmzZPI(IntSize.Companion.m6795getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        m5584placeAtf8xVGno(m5582getPositionnOccac(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno  reason: not valid java name */
    public final void m5584placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        m5581placeSelfgyyYBs(j);
    ...
    private final void m5581placeSelfgyyYBs(long j) {
        if (!IntOffset.m6747equalsimpl0(m5582getPositionnOccac(), j)) {
            m5587setPositiongyyYBs(j);
    ...
    public final void m5585placeSelfApparentToRealOffsetgyyYBs$ui_release(long j) {
        long r0 = m5403getApparentToRealOffsetnOccac();
        m5581placeSelfgyyYBs(IntOffsetKt.IntOffset(IntOffset.m6748getXimpl(j) + IntOffset.m6748getXimpl(r0), IntOffset.m6749getYimpl(j) + IntOffset.m6749getYimpl(r0)));
    }
    ...
    public final Placeable m5583performingMeasureK40F9xA(long j, Function0<? extends MeasureResult> function0) {
    ...
    public final long m5586positionInBjo55l4$ui_release(LookaheadDelegate lookaheadDelegate) {
        long r0 = IntOffset.Companion.m6758getZeronOccac();
        LookaheadDelegate lookaheadDelegate2 = this;
        while (!Intrinsics.areEqual((Object) lookaheadDelegate2, (Object) lookaheadDelegate)) {
            long r3 = lookaheadDelegate2.m5582getPositionnOccac();
            r0 = IntOffsetKt.IntOffset(IntOffset.m6748getXimpl(r0) + IntOffset.m6748getXimpl(r3), IntOffset.m6749getYimpl(r0) + IntOffset.m6749getYimpl(r3));
