...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5468requireCoordinator64DMado(node, NodeKind.m5647constructorimpl(8)));
        }
        return DelegatableNodeKt.m5468requireCoordinator64DMado(node, NodeKind.m5647constructorimpl(8)).touchBoundsInRoot();
    }
}
