...
final class TypefaceBuilderCompat {
    ...
    public final Typeface createFromAssets(AssetManager assetManager, String str, Context context, FontVariation.Settings settings) {
        ...
        return NotificationCompat$$ExternalSyntheticApiModelOutline0.m(assetManager, str).setFontVariationSettings(toVariationSettings(settings, context)).build();
    }
    ...
    public final Typeface createFromFile(File file, Context context, FontVariation.Settings settings) {
        ...
        return NotificationCompat$$ExternalSyntheticApiModelOutline0.m(file).setFontVariationSettings(toVariationSettings(settings, context)).build();
    }
    ...
    public final Typeface createFromFileDescriptor(ParcelFileDescriptor parcelFileDescriptor, Context context, FontVariation.Settings settings) {
        ...
        return NotificationCompat$$ExternalSyntheticApiModelOutline0.m(parcelFileDescriptor.getFileDescriptor()).setFontVariationSettings(toVariationSettings(settings, context)).build();
    }
