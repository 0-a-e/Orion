...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6107getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m6158equalsimpl0(i, FontStyle.Companion.m6164getItalic_LCdwA()));
    }
}
