...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int m6108getStyle_LCdwA() {
        return this.style;
    }

    private AndroidPreloadedFont(FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m6150getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, (DefaultConstructorMarker) null);
