...
public final class TextMotion {
    ...
    public static final TextMotion Animated = new TextMotion(Linearity.Companion.m6499getLinear4e0Vf04(), true, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final TextMotion Static = new TextMotion(Linearity.Companion.m6498getFontHinting4e0Vf04(), false, (DefaultConstructorMarker) null);
    ...
    public final int m6490getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m6488copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m6489copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m6489copyJdDtMQo$ui_text_release(int i, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        return Linearity.m6494equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }

    public int hashCode() {
        return (Linearity.m6495hashCodeimpl(this.linearity) * 31) + UByte$$ExternalSyntheticBackport0.m(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
        /* access modifiers changed from: private */
        public static final int FontHinting = m6492constructorimpl(2);
        /* access modifiers changed from: private */
        public static final int Linear = m6492constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int None = m6492constructorimpl(3);
        private final int value;

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m6491boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m6492constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m6493equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m6497unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m6494equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m6495hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object obj) {
            return m6493equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m6495hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m6499getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m6498getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m6500getNone4e0Vf04() {
        ...
        public static String m6496toStringimpl(int i) {
            if (m6494equalsimpl0(i, Linear)) {
                return "Linearity.Linear";
            }
            if (m6494equalsimpl0(i, FontHinting)) {
                return "Linearity.FontHinting";
            }
            if (m6494equalsimpl0(i, None)) {
                return "Linearity.None";
            }
            return "Invalid";
        }
