...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        /* renamed from: getColor-0d7_KjU  reason: not valid java name */
        public long m6483getColor0d7_KjU() {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m6482from8_81llA(TextDrawStyleKt.m6480modulateDxMtmZc(((SolidColor) brush).m4212getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m6482from8_81llA(long j) {
            return j != Color.Companion.m3852getUnspecified0d7_KjU() ? new ColorStyle(j, (DefaultConstructorMarker) null) : Unspecified.INSTANCE;
        }
    }
}
