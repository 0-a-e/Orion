...
public final class TextOverflow {
    ...
    public static final int Clip = m6502constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Ellipsis = m6502constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Visible = m6502constructorimpl(3);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextOverflow m6501boximpl(int i) {
    ...
    public static boolean m6503equalsimpl(int i, Object obj) {
        return (obj instanceof TextOverflow) && i == ((TextOverflow) obj).m6507unboximpl();
    }
    ...
    public static String m6506toStringimpl(int i) {
        if (m6504equalsimpl0(i, Clip)) {
            return "Clip";
        }
        if (m6504equalsimpl0(i, Ellipsis)) {
            return "Ellipsis";
        }
        if (m6504equalsimpl0(i, Visible)) {
            return "Visible";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6508getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m6509getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m6510getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m6511getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8  reason: not valid java name */
        public final int m6512getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8  reason: not valid java name */
        public final int m6513getVisiblegIe3tQ8() {
