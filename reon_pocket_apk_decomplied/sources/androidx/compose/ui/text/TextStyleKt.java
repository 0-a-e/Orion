...
public final class TextStyleKt {
    ...
    public static final int m6088resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m6470equalsimpl0(i, TextDirection.Companion.m6474getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.Companion.m6475getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.Companion.m6476getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        } else if (!TextDirection.m6470equalsimpl0(i, TextDirection.Companion.m6479getUnspecifieds_7Xco())) {
            return i;
        } else {
            int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i3 == 1) {
                return TextDirection.Companion.m6477getLtrs_7Xco();
            }
            if (i3 == 2) {
                return TextDirection.Companion.m6478getRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
    }
