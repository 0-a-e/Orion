...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        ...
        this.maxLines = i;
        if (Constraints.m6528getMinWidthimpl(j) == 0 && Constraints.m6527getMinHeightimpl(j) == 0) {
            ...
            while (true) {
                ...
                if (Constraints.m6521getHasBoundedHeightimpl(j)) {
                    i2 = RangesKt.coerceAtLeast(Constraints.m6525getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f), i4);
                } else {
                    i2 = Constraints.m6525getMaxHeightimpl(j);
                }
                Paragraph r15 = ParagraphKt.m5935Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, r14, 0, i2, 5, (Object) null), this.maxLines - i5, z);
            ...
            this.width = (float) Constraints.m6526getMaxWidthimpl(j);
    ...
    public MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, float f, Density density, Font.ResourceLoader resourceLoader) {
        this(new MultiParagraphIntrinsics(annotatedString, textStyle, list, density, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader)), ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f), 0, 0, 13, (Object) null), i, z, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ void m5910paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.Companion.m3852getUnspecified0d7_KjU();
        }
        multiParagraph.m5916paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m5916paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            paragraphInfo.getParagraph().m5923paintRPmYEkk(canvas, j, shadow, textDecoration);
    ...
    public static /* synthetic */ void m5909paintLG529CI$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        ...
        multiParagraph.m5915paintLG529CI(canvas, r0, shadow2, textDecoration2, drawStyle2, (i2 & 32) != 0 ? DrawScope.Companion.m4473getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: paint-LG529CI  reason: not valid java name */
    public final void m5915paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            ParagraphInfo paragraphInfo = list.get(i2);
            paragraphInfo.getParagraph().m5922paintLG529CI(canvas, j, shadow, textDecoration, drawStyle, i);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
    ...
    public static /* synthetic */ void m5911painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        multiParagraph.m5917painthn5TExg(canvas, brush, (i2 & 4) != 0 ? Float.NaN : f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.Companion.m4473getDefaultBlendMode0nO6VwU() : i);
    }

    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public final void m5917painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        AndroidMultiParagraphDraw_androidKt.m6309drawMultiParagraph7AXcY_I(this, canvas, brush, f, shadow, textDecoration, drawStyle, i);
    }
    ...
    public final Path getPathForRange(int i, int i2) {
        if (i < 0 || i > i2 || i2 > getAnnotatedString().getText().length()) {
            ...
            MultiParagraphKt.m5918findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(i, i2), new MultiParagraph$getPathForRange$2(Path, i, i2));
            return Path;
        }
    }
    ...
    public final int m5913getOffsetForPositionk4lQ0M(long j) {
        int i;
        if (Offset.m3563getYimpl(j) <= 0.0f) {
            i = 0;
        } else if (Offset.m3563getYimpl(j) >= this.height) {
            i = CollectionsKt.getLastIndex(this.paragraphInfoList);
        } else {
            i = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m3563getYimpl(j));
        }
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(i);
        if (paragraphInfo.getLength() == 0) {
            return paragraphInfo.getStartIndex();
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().m5920getOffsetForPositionk4lQ0M(paragraphInfo.m5932toLocalMKHz9U(j)));
    }
    ...
    public final float[] m5912fillBoundingBoxes8ffj60Q(long j, float[] fArr, int i) {
        requireIndexInRange(TextRange.m6040getMinimpl(j));
        requireIndexInRangeInclusiveEnd(TextRange.m6039getMaximpl(j));
        Ref.IntRef intRef = new Ref.IntRef();
        intRef.element = i;
        MultiParagraphKt.m5918findParagraphsByRangeSbBc2M(this.paragraphInfoList, j, new MultiParagraph$fillBoundingBoxes$1(j, fArr, intRef, new Ref.FloatRef()));
        return fArr;
    }
    ...
    public final long m5914getWordBoundaryjx7JFs(int i) {
        int i2;
        requireIndexInRangeInclusiveEnd(i);
        if (i == getAnnotatedString().length()) {
            i2 = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(i2);
        return paragraphInfo.m5931toGlobalGEjPoXI(paragraphInfo.getParagraph().m5921getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(i)));
    }
