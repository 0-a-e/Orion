...
final class IdentityArrayMap$asMap$1$entries$1$iterator$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Map.Entry<? extends Key, ? extends Value>>, Continuation<? super Unit>, Object> {
    int I$0;
    int I$1;
