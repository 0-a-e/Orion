...
public final class IdentityArrayMap$asMap$1$keys$1 implements Set<Key>, KMappedMarker {
    ...
    public Iterator<Key> iterator() {
        return SequencesKt.sequence(new IdentityArrayMap$asMap$1$keys$1$iterator$1(this.this$0, (Continuation<? super IdentityArrayMap$asMap$1$keys$1$iterator$1>) null)).iterator();
    }
