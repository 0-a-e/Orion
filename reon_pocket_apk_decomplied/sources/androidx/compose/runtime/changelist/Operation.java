...
public abstract class Operation {
    ...
    public String m3294intParamNamew8GmfQM(int i) {
        return "IntParameter(" + i + ')';
    }

    /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
    public String m3295objectParamName31yXWZQ(int i) {
    ...
    public static final class IntParameter {
        ...
        public static final /* synthetic */ IntParameter m3331boximpl(int i) {
        ...
        public static boolean m3333equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m3337unboximpl();
        }
        ...
        public static String m3336toStringimpl(int i) {
            return "IntParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m3333equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3335hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3336toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m3337unboximpl() {
            return this.offset;
        }
    ...
    public static final class ObjectParameter<T> {
        ...
        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m3344boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static <T> int m3345constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m3346equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m3350unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m3347equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m3348hashCodeimpl(int i) {
            return i;
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m3349toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m3346equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m3348hashCodeimpl(this.offset);
        }

        public String toString() {
            return m3349toStringimpl(this.offset);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m3350unboximpl() {
            return this.offset;
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m3375getCountjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3376intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "count";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int r1 = operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0));
            for (int i = 0; i < r1; i++) {
                applier.up();
            }
        }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m3312getNodesHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object down : (Object[]) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))) {
                applier.down(down);
            }
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3313objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "nodes";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        }
    }
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public final int m3296getDistancejn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3297intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "distance";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m3364getEffectHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3365objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "effect";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3360objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "value";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)));
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ  reason: not valid java name */
        public final int m3372getValueHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE  reason: not valid java name */
        public final int m3371getGroupSlotIndexjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3373intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3374objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "value";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object r0 = operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0));
            int r2 = operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0));
            if (r0 instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) r0).getWrapped());
            }
            Object obj = slotWriter.set(r2, r0);
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m3366getDataHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3367objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3318objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "anchor";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m3338getOffsetjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3339intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "offset";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m3314getActionHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ  reason: not valid java name */
        public final int m3315getCompositionHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3316objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "anchor";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
                return "composition";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))).invoke((Composition) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ  reason: not valid java name */
        public final int m3369getValueHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ  reason: not valid java name */
        public final int m3368getBlockHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3370objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "value";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)));
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        public final int m3362getRemoveIndexjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE  reason: not valid java name */
        public final int m3361getCountjn0FJLE() {
            return IntParameter.m3332constructorimpl(1);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3363intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "removeIndex";
            }
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(1))) {
                return "count";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0)), operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(1)));
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        public final int m3341getFromjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE  reason: not valid java name */
        public final int m3342getTojn0FJLE() {
            return IntParameter.m3332constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE  reason: not valid java name */
        public final int m3340getCountjn0FJLE() {
            return IntParameter.m3332constructorimpl(2);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3343intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
            ...
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(2))) {
                return "count";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0)), operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(1)), operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ  reason: not valid java name */
        public final int m3324getAnchorHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3326objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "anchor";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1));
            slotWriter.beginInsert();
            slotWriter.moveFrom(slotTable, ((Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))).toIndexFor(slotTable), false);
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        public final int m3328getFixupsHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(2);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3330objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "anchor";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
            ...
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(2))) {
                return "fixups";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m3319getFactoryHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE  reason: not valid java name */
        public final int m3321getInsertIndexjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ  reason: not valid java name */
        public final int m3320getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3322intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "insertIndex";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3323objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "factory";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object invoke = ((Function0) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))).invoke();
            int r3 = operationArgContainer.m3377getIntw8GmfQM(IntParameter.m3332constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode((Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1)), invoke);
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* renamed from: getInsertIndex-jn0FJLE  reason: not valid java name */
        public final int m3352getInsertIndexjn0FJLE() {
            return IntParameter.m3332constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ  reason: not valid java name */
        public final int m3351getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: intParamName-w8GmfQM  reason: not valid java name */
        public String m3353intParamNamew8GmfQM(int i) {
            if (IntParameter.m3334equalsimpl0(i, IntParameter.m3332constructorimpl(0))) {
                return "insertIndex";
            }
            return Operation.super.m3294intParamNamew8GmfQM(i);
        ...
        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3354objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "groupAnchor";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(r2, slotWriter.node((Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))));
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m3310getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ  reason: not valid java name */
        public final int m3309getAnchorHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3311objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            ((IntRef) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))).setElement(OperationKt.positionToInsert(slotWriter, (Anchor) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1)), applier));
        }
    }
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m3301getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ  reason: not valid java name */
        public final int m3302getNodesHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3303objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m3306getResolvedStateHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ  reason: not valid java name */
        public final int m3305getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ  reason: not valid java name */
        public final int m3304getFromHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ  reason: not valid java name */
        public final int m3307getToHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(3);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3308objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
            ...
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(3))) {
                return "to";
            }
            return Operation.super.m3295objectParamName31yXWZQ(i);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1));
            MovableContentState movableContentState = (MovableContentState) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ  reason: not valid java name */
        public final int m3355getCompositionHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ  reason: not valid java name */
        public final int m3356getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ  reason: not valid java name */
        public final int m3357getReferenceHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(2);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3358objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "composition";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0)), (CompositionContext) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1)), (MovableContentStateReference) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(2)), slotWriter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m3298getChangesHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ  reason: not valid java name */
        public final int m3299getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m3345constructorimpl(1);
        }

        /* renamed from: objectParamName-31yXWZQ  reason: not valid java name */
        public String m3300objectParamName31yXWZQ(int i) {
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(0))) {
                return "changes";
            }
            if (ObjectParameter.m3347equalsimpl0(i, ObjectParameter.m3345constructorimpl(1))) {
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.m3378getObject31yXWZQ(ObjectParameter.m3345constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                arrayList.add(IntParameter.m3331boximpl(IntParameter.m3332constructorimpl(i3)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m3344boximpl(ObjectParameter.m3345constructorimpl(i4)));
            }
