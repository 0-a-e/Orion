...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m3399assert(this.nodeMap == 0);
        CommonFunctionsKt.m3399assert(this.dataMap == 0);
        CommonFunctionsKt.m3399assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m3399assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        return makeNode(hashCode, keyAtIndex3, valueAtKeyIndex3, i4, keyAtIndex4, valueAtKeyIndex4, i2 + 5, persistentHashMapBuilder.getOwnership());
    }
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> trieNode, int i, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (this == trieNode3) {
            ...
            return mutableCollisionPutAll(trieNode3, deltaCounter2, persistentHashMapBuilder.getOwnership());
        } else {
            ...
            if ((i2 & i6) == 0) {
                if (Intrinsics.areEqual((Object) this.ownedBy, (Object) persistentHashMapBuilder.getOwnership()) && this.dataMap == i6 && this.nodeMap == i2) {
                    trieNode2 = this;
                } else {
    ...
    public final TrieNode<K, V> mutablePut(int i, K k, V v, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            return mutableUpdateNodeAtIndex(nodeIndex$runtime_release, trieNode, persistentHashMapBuilder.getOwnership());
        } else {
            persistentHashMapBuilder.setSize(persistentHashMapBuilder.size() + 1);
    ...
    public final TrieNode<K, V> mutableRemove(int i, K k, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            return mutableReplaceNode(nodeAtIndex$runtime_release, trieNode, nodeIndex$runtime_release, indexSegment, persistentHashMapBuilder.getOwnership());
        }
    }
