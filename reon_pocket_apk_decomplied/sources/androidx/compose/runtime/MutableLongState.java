...
public interface MutableLongState extends LongState, MutableState<Long> {
    ...
    public final /* synthetic */ class CC {
        ...
        public static void $default$setValue(MutableLongState _this, long j) {
            _this.setLongValue(j);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static Long getValue(MutableLongState mutableLongState) {
            return Long.valueOf(CC.$default$getValue(mutableLongState).longValue());
        }

        @Deprecated
        public static void setValue(MutableLongState mutableLongState, long j) {
            CC.$default$setValue(mutableLongState, j);
        }
    }
}
