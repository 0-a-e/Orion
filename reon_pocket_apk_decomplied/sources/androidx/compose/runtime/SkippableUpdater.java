...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3273boximpl(Composer composer2) {
        return new SkippableUpdater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m3274constructorimpl(Composer composer2) {
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3275equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual((Object) composer2, (Object) ((SkippableUpdater) obj).m3280unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3276equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m3277hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3278toStringimpl(Composer composer2) {
        return "SkippableUpdater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m3275equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3277hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3278toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m3280unboximpl() {
    ...
    public static final void m3279updateimpl(Composer composer2, Function1<? super Updater<T>, Unit> function1) {
        composer2.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3281boximpl(Updater.m3282constructorimpl(composer2)));
