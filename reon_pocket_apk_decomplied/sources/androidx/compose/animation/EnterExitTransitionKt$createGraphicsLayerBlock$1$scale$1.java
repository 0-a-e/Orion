...
final class EnterExitTransitionKt$createGraphicsLayerBlock$1$scale$1 extends Lambda implements Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<Float>> {
    final /* synthetic */ EnterTransition $enter;
    final /* synthetic */ ExitTransition $exit;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EnterExitTransitionKt$createGraphicsLayerBlock$1$scale$1(EnterTransition enterTransition, ExitTransition exitTransition) {
        super(1);
