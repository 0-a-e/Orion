...
final class AnimatedContentMeasurePolicy$measure$3 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        for (Placeable placeable : placeableArr) {
            if (placeable != null) {
                long r8 = animatedContentMeasurePolicy.getRootScope().getContentAlignment().m3417alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                Placeable.PlacementScope.place$default(placementScope, placeable, IntOffset.m6748getXimpl(r8), IntOffset.m6749getYimpl(r8), 0.0f, 4, (Object) null);
            }
        }
    }
}
