...
final class EnterExitTransitionKt$createGraphicsLayerBlock$1$transformOrigin$2 extends Lambda implements Function1<EnterExitState, TransformOrigin> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            L_0x0022:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.EnterExitTransitionKt$createGraphicsLayerBlock$1$transformOrigin$2.WhenMappings.<clinit>():void");
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EnterExitTransitionKt$createGraphicsLayerBlock$1$transformOrigin$2(TransformOrigin transformOrigin, EnterTransition enterTransition, ExitTransition exitTransition) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return TransformOrigin.m4256boximpl(m79invokeLIALnN8((EnterExitState) obj));
    }
    ...
    public final long m79invokeLIALnN8(EnterExitState enterExitState) {
        ...
        if (i != 1) {
            ...
            if (i == 2) {
                ...
                if (!(scale == null && (scale = this.$exit.getData$animation_release().getScale()) == null)) {
                    transformOrigin = TransformOrigin.m4256boximpl(scale.m102getTransformOriginSzJe1aQ());
                }
            } else if (i == 3) {
                ...
                if (!(scale2 == null && (scale2 = this.$enter.getData$animation_release().getScale()) == null)) {
                    transformOrigin = TransformOrigin.m4256boximpl(scale2.m102getTransformOriginSzJe1aQ());
                }
            } else {
        ...
        if (transformOrigin != null) {
            return transformOrigin.m4268unboximpl();
        }
        return TransformOrigin.Companion.m4269getCenterSzJe1aQ();
    }
}
