...
final class SeekableTransitionState$animateToTargetState$2 extends Lambda implements Function1<Animatable<Float, AnimationVector1D>, Unit> {
    final /* synthetic */ SeekableTransitionState<S> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SeekableTransitionState$animateToTargetState$2(SeekableTransitionState<S> seekableTransitionState) {
        super(1);
