...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public KeyframeEntity<T> createEntityFor$animation_core_release(T t) {
            return new KeyframeEntity<>(t, (Easing) null, 2, (DefaultConstructorMarker) null);
        }
        ...
        public KeyframeEntity<T> atFraction(T t, float f) {
            return at((Object) t, MathKt.roundToInt(((float) getDurationMillis()) * f));
        }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public KeyframeEntity(T t, Easing easing) {
            super(t, easing, (DefaultConstructorMarker) null);
        }

        public boolean equals(Object obj) {
            if (obj instanceof KeyframeEntity) {
                KeyframeEntity keyframeEntity = (KeyframeEntity) obj;
                return Intrinsics.areEqual(keyframeEntity.getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual((Object) keyframeEntity.getEasing$animation_core_release(), (Object) getEasing$animation_core_release());
            }
        }
