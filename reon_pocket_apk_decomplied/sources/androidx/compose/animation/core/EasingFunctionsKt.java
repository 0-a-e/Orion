...
public final class EasingFunctionsKt {
    ...
    private static final Easing EaseInBounce = new EasingFunctionsKt$$ExternalSyntheticLambda4();
    ...
    private static final Easing EaseInElastic = new EasingFunctionsKt$$ExternalSyntheticLambda0();
    ...
    private static final Easing EaseInOutBounce = new EasingFunctionsKt$$ExternalSyntheticLambda5();
    ...
    private static final Easing EaseInOutElastic = new EasingFunctionsKt$$ExternalSyntheticLambda2();
    ...
    private static final Easing EaseOutBounce = new EasingFunctionsKt$$ExternalSyntheticLambda3();
    ...
    private static final Easing EaseOutElastic = new EasingFunctionsKt$$ExternalSyntheticLambda1();
    ...
    public static final float EaseInBounce$lambda$4(float f) {
        return ((float) 1) - EaseOutBounce.transform(1.0f - f);
    }
    ...
    public static final float EaseInOutBounce$lambda$5(float f) {
        float f2;
        if (((double) f) < 0.5d) {
            f2 = ((float) 1) - EaseOutBounce.transform(1.0f - (f * 2.0f));
        } else {
            f2 = ((float) 1) + EaseOutBounce.transform((f * 2.0f) - 1.0f);
        }
        return f2 / 2.0f;
    }
}
