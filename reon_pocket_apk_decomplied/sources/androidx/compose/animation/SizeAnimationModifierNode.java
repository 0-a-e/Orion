...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public /* synthetic */ SizeAnimationModifierNode(AnimationSpec animationSpec2, Function2 function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(animationSpec2, (i & 2) != 0 ? null : function2);
    }
    ...
    public SizeAnimationModifierNode(AnimationSpec<IntSize> animationSpec2, Function2<? super IntSize, ? super IntSize, Unit> function2) {
        this.animationSpec = animationSpec2;
        this.listener = function2;
    ...
    private final long m107targetConstraintsZezNO4M(long j) {
    ...
    public static final class AnimData {
        ...
        public static /* synthetic */ AnimData m110copyO0kMr_c$default(AnimData animData, Animatable<IntSize, AnimationVector2D> animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
        ...
        public final long m111component2YbymL2g() {
            return this.startSize;
        }

        /* renamed from: copy-O0kMr_c  reason: not valid java name */
        public final AnimData m112copyO0kMr_c(Animatable<IntSize, AnimationVector2D> animatable, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.anim, (Object) animData.anim) && IntSize.m6788equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m6791hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + IntSize.m6793toStringimpl(this.startSize) + ')';
        }
    ...
    public MeasureResult m109measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Placeable placeable;
        if (measureScope.isLookingAhead()) {
            m106setLookaheadConstraintsBRTryo0(j);
            placeable = measurable.m5368measureBRTryo0(j);
        } else {
            placeable = measurable.m5368measureBRTryo0(m107targetConstraintsZezNO4M(j));
        }
        long IntSize = IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight());
        if (measureScope.isLookingAhead()) {
            this.lookaheadSize = IntSize;
        } else {
            if (AnimationModifierKt.m69isValidozmzZPI(this.lookaheadSize)) {
                IntSize = this.lookaheadSize;
            }
            IntSize = ConstraintsKt.m6537constrain4WqzIAM(j, m108animateTomzRDjE0(IntSize));
        }
        return MeasureScope.CC.layout$default(measureScope, IntSize.m6790getWidthimpl(IntSize), IntSize.m6789getHeightimpl(IntSize), (Map) null, new SizeAnimationModifierNode$measure$2(placeable), 4, (Object) null);
    }

    /* renamed from: animateTo-mzRDjE0  reason: not valid java name */
    public final long m108animateTomzRDjE0(long j) {
        long j2 = j;
        AnimData animData = getAnimData();
        if (animData == null) {
            animData = new AnimData(new Animatable(IntSize.m6782boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m6782boximpl(IntSizeKt.IntSize(1, 1)), (String) null, 8, (DefaultConstructorMarker) null), j2, (DefaultConstructorMarker) null);
        } else if (!IntSize.m6788equalsimpl0(j2, animData.getAnim().getTargetValue().m6794unboximpl())) {
            animData.m114setStartSizeozmzZPI(animData.getAnim().getValue().m6794unboximpl());
