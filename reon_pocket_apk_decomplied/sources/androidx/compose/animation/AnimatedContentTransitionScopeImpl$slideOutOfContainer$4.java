...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m6749getYimpl(this.this$0.m56calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), r0))) + IntSize.m6789getHeightimpl(r0)));
    }
}
