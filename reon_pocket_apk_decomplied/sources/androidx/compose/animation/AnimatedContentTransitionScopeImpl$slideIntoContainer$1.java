...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$1 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        return this.$initialOffset.invoke(Integer.valueOf(IntSize.m6790getWidthimpl(this.this$0.m57getCurrentSizeYbymL2g()) - IntOffset.m6748getXimpl(this.this$0.m56calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.this$0.m57getCurrentSizeYbymL2g()))));
    }
}
