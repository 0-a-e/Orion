...
public final class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m234copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush2, Shape shape2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m236copy8Feqmps(f, brush2, shape2);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m235component1D9Ej5fM() {
        return this.width;
    }
    ...
    public final BorderModifierNodeElement m236copy8Feqmps(float f, Brush brush2, Shape shape2) {
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m6619equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual((Object) this.brush, (Object) borderModifierNodeElement.brush) && Intrinsics.areEqual((Object) this.shape, (Object) borderModifierNodeElement.shape);
    }

    public int hashCode() {
        return (((Dp.m6620hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + Dp.m6625toStringimpl(this.width) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }

    /* renamed from: getWidth-D9Ej5fM  reason: not valid java name */
    public final float m237getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode borderModifierNode) {
        borderModifierNode.m233setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m6612boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m3806boximpl(((SolidColor) this.brush).m4212getValue0d7_KjU()));
            inspectorInfo.setValue(Color.m3806boximpl(((SolidColor) this.brush).m4212getValue0d7_KjU()));
        } else {
