...
final class PagerKt$HorizontalPager$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        PagerKt.m973HorizontalPagerxYaah8o(pagerState2, modifier, paddingValues, pageSize, i2, f, vertical, snapFlingBehavior, z, z2, function1, nestedScrollConnection, function4, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1), this.$$default);
    }
}
