...
public final class LazyAnimateScrollKt {
    ...
    public static final float BoundDistance = Dp.m6614constructorimpl((float) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final boolean DEBUG = false;
    /* access modifiers changed from: private */
    public static final float MinimumDistance = Dp.m6614constructorimpl((float) 50);
    /* access modifiers changed from: private */
    public static final float TargetDistance = Dp.m6614constructorimpl((float) 2500);
    ...
    public static final Object animateScrollToItem(LazyLayoutAnimateScrollScope lazyLayoutAnimateScrollScope, int i, int i2, int i3, Density density, Continuation<? super Unit> continuation) {
        Object scroll = lazyLayoutAnimateScrollScope.scroll(new LazyAnimateScrollKt$animateScrollToItem$2(i, density, lazyLayoutAnimateScrollScope, i2, i3, (Continuation<? super LazyAnimateScrollKt$animateScrollToItem$2>) null), continuation);
