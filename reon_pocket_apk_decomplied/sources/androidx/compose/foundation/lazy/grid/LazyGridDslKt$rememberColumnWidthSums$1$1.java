...
final class LazyGridDslKt$rememberColumnWidthSums$1$1 extends Lambda implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m833invoke0kLqBqw((Density) obj, ((Constraints) obj2).m6532unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyGridSlots m833invoke0kLqBqw(Density density, long j) {
        if (Constraints.m6526getMaxWidthimpl(j) != Integer.MAX_VALUE) {
            ...
            int[] intArray = CollectionsKt.toIntArray(gridCells.calculateCrossAxisCellSizes(density, r2, density.m6545roundToPx0680j_4(horizontal.m552getSpacingD9Ej5fM())));
