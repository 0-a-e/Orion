...
final class LazyStaggeredGridItemProviderImpl implements LazyStaggeredGridItemProvider {
    ...
    public void Item(int i, Object obj, Composer composer, int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(obj, i, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.composableLambda(startRestartGroup, 608834466, true, new LazyStaggeredGridItemProviderImpl$Item$1(this, i)), startRestartGroup, ((i2 << 3) & 112) | 3592);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new LazyStaggeredGridItemProviderImpl$Item$2(this, i, obj, i2));
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.intervalContent, (Object) ((LazyStaggeredGridItemProviderImpl) obj).intervalContent);
    }
