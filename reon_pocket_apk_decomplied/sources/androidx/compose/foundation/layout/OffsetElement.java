...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode offsetNode) {
        offsetNode.m633setX0680j_4(this.x);
        offsetNode.m634setY0680j_4(this.y);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Dp.m6619equalsimpl0(this.x, offsetElement.x) || !Dp.m6619equalsimpl0(this.y, offsetElement.y) || this.rtlAware != offsetElement.rtlAware) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((Dp.m6620hashCodeimpl(this.x) * 31) + Dp.m6620hashCodeimpl(this.y)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + Dp.m6625toStringimpl(this.x) + ", y=" + Dp.m6625toStringimpl(this.y) + ", rtlAware=" + this.rtlAware + ')';
    }
