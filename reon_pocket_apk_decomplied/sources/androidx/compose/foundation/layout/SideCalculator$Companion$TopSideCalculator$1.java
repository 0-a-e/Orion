...
public final class SideCalculator$Companion$TopSideCalculator$1 implements SideCalculator {
    ...
    public long m724consumedOffsetsMKHz9U(long j) {
        return OffsetKt.Offset(0.0f, Offset.m3563getYimpl(j));
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m725consumedVelocityQWom1Mo(long j, float f) {
        return VelocityKt.Velocity(0.0f, Velocity.m6856getYimpl(j) - f);
    }
}
