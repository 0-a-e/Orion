...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public final float m514getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m513getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine2, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((f < 0.0f && !Dp.m6619equalsimpl0(f, Dp.Companion.m6634getUnspecifiedD9Ej5fM())) || (f2 < 0.0f && !Dp.m6619equalsimpl0(f2, Dp.Companion.m6634getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode alignmentLineOffsetDpNode) {
        ...
        alignmentLineOffsetDpNode.m519setBefore0680j_4(this.before);
        alignmentLineOffsetDpNode.m518setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.alignmentLine, (Object) alignmentLineOffsetDpElement.alignmentLine) || !Dp.m6619equalsimpl0(this.before, alignmentLineOffsetDpElement.before) || !Dp.m6619equalsimpl0(this.after, alignmentLineOffsetDpElement.after)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m6620hashCodeimpl(this.before)) * 31) + Dp.m6620hashCodeimpl(this.after);
    }
}
