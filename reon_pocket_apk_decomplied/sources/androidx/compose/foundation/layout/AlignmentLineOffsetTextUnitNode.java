...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m523getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m526setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m522getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m525setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult m524measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m504alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m6829isUnspecifiedR2X_6o(this.before) ? measureScope.m6723toDpGaN1DYA(this.before) : Dp.Companion.m6634getUnspecifiedD9Ej5fM(), !TextUnitKt.m6829isUnspecifiedR2X_6o(this.after) ? measureScope.m6723toDpGaN1DYA(this.after) : Dp.Companion.m6634getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
