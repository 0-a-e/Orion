...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m677getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: setStart-0680j_4  reason: not valid java name */
    public final void m682setStart0680j_4(float f) {
        this.start = f;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m678getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: setTop-0680j_4  reason: not valid java name */
    public final void m683setTop0680j_4(float f) {
        this.top = f;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m676getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: setEnd-0680j_4  reason: not valid java name */
    public final void m681setEnd0680j_4(float f) {
        this.end = f;
    }

    /* renamed from: getBottom-D9Ej5fM  reason: not valid java name */
    public final float m675getBottomD9Ej5fM() {
        return this.bottom;
    }

    /* renamed from: setBottom-0680j_4  reason: not valid java name */
    public final void m680setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult m679measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        int r0 = measureScope.m6545roundToPx0680j_4(this.start) + measureScope.m6545roundToPx0680j_4(this.end);
        int r1 = measureScope.m6545roundToPx0680j_4(this.top) + measureScope.m6545roundToPx0680j_4(this.bottom);
        Placeable r12 = measurable.m5368measureBRTryo0(ConstraintsKt.m6542offsetNN6EwU(j, -r0, -r1));
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m6540constrainWidthK40F9xA(j, r12.getWidth() + r0), ConstraintsKt.m6539constrainHeightK40F9xA(j, r12.getHeight() + r1), (Map) null, new PaddingNode$measure$1(this, r12, measureScope), 4, (Object) null);
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6614constructorimpl((float) 0) : f, (i & 2) != 0 ? Dp.m6614constructorimpl((float) 0) : f2, (i & 4) != 0 ? Dp.m6614constructorimpl((float) 0) : f3, (i & 8) != 0 ? Dp.m6614constructorimpl((float) 0) : f4, z, (DefaultConstructorMarker) null);
    }
}
