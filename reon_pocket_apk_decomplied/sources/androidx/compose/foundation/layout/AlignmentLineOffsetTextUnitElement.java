...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public final long m521getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m520getAfterXSAIIZE() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine2, long j, long j2, Function1<? super InspectorInfo, Unit> function1) {
    ...
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m6812hashCodeimpl(this.before)) * 31) + TextUnit.m6812hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.alignmentLine, (Object) alignmentLineOffsetTextUnitElement.alignmentLine) || !TextUnit.m6808equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) || !TextUnit.m6808equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after)) {
            return false;
        }
        return true;
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode alignmentLineOffsetTextUnitNode) {
        ...
        alignmentLineOffsetTextUnitNode.m526setBeforeR2X_6o(this.before);
        alignmentLineOffsetTextUnitNode.m525setAfterR2X_6o(this.after);
    }
}
