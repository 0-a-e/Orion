...
final class AbstractDraggableNode$_canDrag$1 extends Lambda implements Function1<PointerInputChange, Boolean> {
    final /* synthetic */ AbstractDraggableNode this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AbstractDraggableNode$_canDrag$1(AbstractDraggableNode abstractDraggableNode) {
        super(1);
