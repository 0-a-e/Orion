...
final class ScrollableElement extends ModifierNodeElement<ScrollableNode> {
    ...
    public int hashCode() {
        ...
        int i = 0;
        int hashCode2 = (((((hashCode + (overscrollEffect2 != null ? overscrollEffect2.hashCode() : 0)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.enabled)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.reverseDirection)) * 31;
        ...
        return ((hashCode3 + i) * 31) + this.bringIntoViewSpec.hashCode();
    }
