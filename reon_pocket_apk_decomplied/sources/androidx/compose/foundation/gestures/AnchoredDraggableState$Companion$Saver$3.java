...
final class AnchoredDraggableState$Companion$Saver$3 extends Lambda implements Function1<T, AnchoredDraggableState<T>> {
    ...
    AnchoredDraggableState$Companion$Saver$3(Function1<? super Float, Float> function1, Function0<Float> function0, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> function12) {
        super(1);
