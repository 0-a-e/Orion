...
public final class OverscrollConfiguration {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m665PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, (Object) null) : paddingValues, (DefaultConstructorMarker) null);
    }

    /* renamed from: getGlowColor-0d7_KjU  reason: not valid java name */
    public final long m311getGlowColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3817equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual((Object) this.drawPadding, (Object) overscrollConfiguration.drawPadding);
    }

    public int hashCode() {
        return (Color.m3823hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + Color.m3824toStringimpl(this.glowColor) + ", drawPadding=" + this.drawPadding + ')';
    }
}
