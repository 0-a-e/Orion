...
final class BasicTooltip_androidKt$TooltipPopup$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CoroutineScope $scope;
    final /* synthetic */ BasicTooltipState $state;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BasicTooltip_androidKt$TooltipPopup$1(BasicTooltipState basicTooltipState, CoroutineScope coroutineScope) {
        super(0);
