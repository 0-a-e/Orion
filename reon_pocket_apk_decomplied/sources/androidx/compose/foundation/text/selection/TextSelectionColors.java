...
public final class TextSelectionColors {
    ...
    public final long m1324getHandleColor0d7_KjU() {
        return this.handleColor;
    }

    /* renamed from: getBackgroundColor-0d7_KjU  reason: not valid java name */
    public final long m1323getBackgroundColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m3817equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m3817equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m3823hashCodeimpl(this.handleColor) * 31) + Color.m3823hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m3824toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m3824toStringimpl(this.backgroundColor) + ')';
    }
}
