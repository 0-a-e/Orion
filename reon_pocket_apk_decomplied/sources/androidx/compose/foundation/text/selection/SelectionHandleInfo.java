...
public final class SelectionHandleInfo {
    ...
    public /* synthetic */ SelectionHandleInfo(Handle handle2, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z, DefaultConstructorMarker defaultConstructorMarker) {
        this(handle2, j, selectionHandleAnchor, z);
    }

    /* renamed from: copy-ubNVwUQ$default  reason: not valid java name */
    public static /* synthetic */ SelectionHandleInfo m1233copyubNVwUQ$default(SelectionHandleInfo selectionHandleInfo, Handle handle2, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m1235copyubNVwUQ(handle2, j2, selectionHandleAnchor2, z);
    }
    ...
    public final long m1234component2F1C5BW0() {
    ...
    public final SelectionHandleInfo m1235copyubNVwUQ(Handle handle2, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z) {
        return new SelectionHandleInfo(handle2, j, selectionHandleAnchor, z, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m3559equalsimpl0(this.position, selectionHandleInfo.position) && this.anchor == selectionHandleInfo.anchor && this.visible == selectionHandleInfo.visible;
    }

    public int hashCode() {
        return (((((this.handle.hashCode() * 31) + Offset.m3564hashCodeimpl(this.position)) * 31) + this.anchor.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.visible);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + Offset.m3570toStringimpl(this.position) + ", anchor=" + this.anchor + ", visible=" + this.visible + ')';
    }

    private SelectionHandleInfo(Handle handle2, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z) {
        this.handle = handle2;
        this.position = j;
    ...
    public final long m1236getPositionF1C5BW0() {
        return this.position;
    }
