...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.Companion.m6047getZerod9O1mEE();
    ...
    public final long m1141getPreviousSelectiond9O1mEE() {
        return this.previousSelection;
    }

    /* renamed from: setPreviousSelection-5zc-tL8  reason: not valid java name */
    public final void m1142setPreviousSelection5zctL8(long j) {
    ...
    public final int m1140getOffsetToFollow5zctL8(long j) {
        if (TextRange.m6042getStartimpl(j) != TextRange.m6042getStartimpl(this.previousSelection)) {
            return TextRange.m6042getStartimpl(j);
        }
        if (TextRange.m6037getEndimpl(j) != TextRange.m6037getEndimpl(this.previousSelection)) {
            return TextRange.m6037getEndimpl(j);
        }
        return TextRange.m6040getMinimpl(j);
    }
