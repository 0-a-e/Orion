...
final class TextAnnotatedStringNode$applySemantics$2 extends Lambda implements Function1<AnnotatedString, Boolean> {
    final /* synthetic */ TextAnnotatedStringNode this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TextAnnotatedStringNode$applySemantics$2(TextAnnotatedStringNode textAnnotatedStringNode) {
        super(1);
        this.this$0 = textAnnotatedStringNode;
    }

    public final Boolean invoke(AnnotatedString annotatedString) {
        boolean unused = this.this$0.setSubstitution(annotatedString);
