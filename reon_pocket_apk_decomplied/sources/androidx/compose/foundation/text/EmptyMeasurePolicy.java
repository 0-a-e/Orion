...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m1068measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.CC.layout$default(measureScope, Constraints.m6526getMaxWidthimpl(j), Constraints.m6525getMaxHeightimpl(j), (Map) null, placementBlock, 4, (Object) null);
    }
}
