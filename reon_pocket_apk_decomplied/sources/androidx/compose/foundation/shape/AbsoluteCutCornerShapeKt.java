...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m1013AbsoluteCutCornerShape0680j_4(float f) {
    ...
    public static final AbsoluteCutCornerShape m1014AbsoluteCutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m1015AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1014AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
