...
public final class AbsoluteRoundedCornerShapeKt {
    ...
    public static final AbsoluteRoundedCornerShape m1018AbsoluteRoundedCornerShape0680j_4(float f) {
    ...
    public static final AbsoluteRoundedCornerShape m1019AbsoluteRoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ AbsoluteRoundedCornerShape m1020AbsoluteRoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1019AbsoluteRoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
