...
final class BasicSecureTextFieldKt$DisableCutCopy$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    BasicSecureTextFieldKt$DisableCutCopy$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C512@23959L346:BasicSecureTextField.kt#g98mwb");
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1741121166, i, -1, "androidx.compose.foundation.text2.DisableCutCopy.<anonymous> (BasicSecureTextField.kt:512)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1102005134, "C518@24286L9:BasicSecureTextField.kt#g98mwb");
