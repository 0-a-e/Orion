...
public final class ClipScrollableContainerKt$HorizontalScrollableClipModifier$1 implements Shape {
    ...
    public Outline m264createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        float r6 = (float) density.m6545roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        return new Outline.Rectangle(new Rect(0.0f, -r6, Size.m3631getWidthimpl(j), Size.m3628getHeightimpl(j) + r6));
    }
}
