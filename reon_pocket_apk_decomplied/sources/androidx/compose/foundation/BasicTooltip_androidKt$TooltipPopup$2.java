...
final class BasicTooltip_androidKt$TooltipPopup$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C135@5070L187:BasicTooltip.android.kt#71ulvw");
        if ((i & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1147839433, i, -1, "androidx.compose.foundation.TooltipPopup.<anonymous> (BasicTooltip.android.kt:135)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1788261149, "C140@5246L9:BasicTooltip.android.kt#71ulvw");
