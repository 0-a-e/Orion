...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m6614constructorimpl((float) 10);
    ...
    public static final float m1486getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m3631getWidthimpl(j), Size.m3628getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1485getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        float r3 = Offset.m3560getDistanceimpl(OffsetKt.Offset(Size.m3631getWidthimpl(j), Size.m3628getHeightimpl(j))) / 2.0f;
        return z ? r3 + density.m6550toPx0680j_4(BoundedRippleExtraRadius) : r3;
    }
}
