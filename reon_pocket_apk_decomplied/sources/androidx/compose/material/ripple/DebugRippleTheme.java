...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long m1481defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long r0 = RippleTheme.Companion.m1494defaultRippleColor5vOe2sY(Color.Companion.m3842getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha r5 = RippleTheme.Companion.m1493defaultRippleAlphaDxMtmZc(Color.Companion.m3842getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
