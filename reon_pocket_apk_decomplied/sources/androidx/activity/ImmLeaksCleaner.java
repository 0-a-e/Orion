...
public final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    public void onStateChanged(androidx.lifecycle.LifecycleOwner r3, androidx.lifecycle.Lifecycle.Event r4) {
        ...
        L_0x002c:
            monitor-enter(r0)
            android.view.View r1 = r4.getServedView(r3)     // Catch:{ all -> 0x0048 }
            if (r1 != 0) goto L_0x0035
            monitor-exit(r0)
            return
        L_0x0035:
            boolean r1 = r1.isAttachedToWindow()     // Catch:{ all -> 0x0048 }
            if (r1 == 0) goto L_0x003d
            monitor-exit(r0)
            return
        L_0x003d:
            boolean r4 = r4.clearNextServedView(r3)     // Catch:{ all -> 0x0048 }
            monitor-exit(r0)
