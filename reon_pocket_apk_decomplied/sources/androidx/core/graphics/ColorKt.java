...
public final class ColorKt {
    ...
    public static final long convertTo(int i, ColorSpace.Named named) {
        return Color.convert(i, Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(named));
    }
    ...
    public static final long convertTo(long j, ColorSpace.Named named) {
        return Color.convert(j, Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(named));
    }
    ...
    public static final Color convertTo(Color color, ColorSpace.Named named) {
        return color.convert(Api26Bitmap$$ExternalSyntheticApiModelOutline0.m(named));
    }
