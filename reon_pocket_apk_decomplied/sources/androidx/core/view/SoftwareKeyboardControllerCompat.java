    ...
    private static class Impl30 extends Impl20 {
        ...
        public void show() {
            ...
            if (windowInsetsController == null) {
                View view = this.mView;
                windowInsetsController = view != null ? ComponentDialog$$ExternalSyntheticApiModelOutline0.m(view) : null;
            }
            if (windowInsetsController != null) {
        ...
        public void hide() {
            ...
            if (windowInsetsController == null) {
                ...
                windowInsetsController = view2 != null ? ComponentDialog$$ExternalSyntheticApiModelOutline0.m(view2) : null;
            }
            if (windowInsetsController != null) {
                AtomicBoolean atomicBoolean = new AtomicBoolean(false);
                SoftwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda5 softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda5 = new SoftwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda5(atomicBoolean);
                windowInsetsController.addOnControllableInsetsChangedListener(softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda5);
                if (!atomicBoolean.get() && (view = this.mView) != null) {
                    ((InputMethodManager) view.getContext().getSystemService("input_method")).hideSoftInputFromWindow(this.mView.getWindowToken(), 0);
                }
                windowInsetsController.removeOnControllableInsetsChangedListener(softwareKeyboardControllerCompat$Impl30$$ExternalSyntheticLambda5);
