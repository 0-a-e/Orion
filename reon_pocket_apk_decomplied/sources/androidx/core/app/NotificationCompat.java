        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (Message androidMessage : this.mMessages) {
                    Api24Impl.addMessage(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), androidMessage.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message androidMessage2 : this.mHistoricMessages) {
                        Api26Impl.addHistoricMessage(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), androidMessage2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), this.mIsGroupConversation.booleanValue());
                }
    ...
    public static class CallStyle extends Style {
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
