...
@Metadata(d1 = {"\u0000\u001b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00060\u0001R\u00020\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016¨\u0006\u0007"}, d2 = {"jp/co/sony/reon/android/ble/service/BleService$readCharacteristic$command$1", "Ljp/co/sony/reon/android/ble/service/BleService$Command;", "Ljp/co/sony/reon/android/ble/service/BleService;", "execute", "", "aGatt", "Landroid/bluetooth/BluetoothGatt;", "reon-ble_debug"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* compiled from: BleService.kt */
public final class BleService$readCharacteristic$command$1 extends BleService.Command {
    final /* synthetic */ BluetoothGattCharacteristic $gattCharacteristic;
    final /* synthetic */ BleService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BleService$readCharacteristic$command$1(BleService bleService, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        super();
    ...
    public void execute(BluetoothGatt bluetoothGatt) {
        ...
        if (bluetoothGatt != null) {
            ...
            if (!bluetoothGatt.readCharacteristic(bluetoothGattCharacteristic)) {
                ...
                if (!bluetoothGatt.readCharacteristic(bluetoothGattCharacteristic)) {
                    ...
                    debugLogUtil.e("BleService", "Read(" + uuid + ") is failed");
                    z2 = true;
                }
            }
            unit = Unit.INSTANCE;
        ...
        if (unit == null) {
            ...
            debugLogUtil2.e("BleService", "Read(" + uuid2 + ") is failed, gatt is null");
        } else {
            z = z2;
        }
        if (z) {
            ...
            bleService.sendFailedMsgWithUuid(5, uuid3, uuid4);
        }
    }
}
