...
public final class ActivityConnectionBinding implements ViewBinding {
    ...
    private ActivityConnectionBinding(LinearLayout linearLayout, NestedScrollView nestedScrollView, FrameLayout frameLayout, TagMiniInfoView tagMiniInfoView) {
        ...
        if (nestedScrollView != null) {
            ...
            if (frameLayout != null) {
                ...
                if (tagMiniInfoView != null) {
                    return new ActivityConnectionBinding((LinearLayout) view, nestedScrollView, frameLayout, tagMiniInfoView);
                }
            }
        }
