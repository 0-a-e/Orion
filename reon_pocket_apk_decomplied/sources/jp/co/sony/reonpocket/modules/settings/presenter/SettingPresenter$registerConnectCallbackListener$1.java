...
final class SettingPresenter$registerConnectCallbackListener$1 extends Lambda implements Function2<BleConnStatusCode, ArrayList<String>, Unit> {
    final /* synthetic */ SettingPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SettingPresenter$registerConnectCallbackListener$1(SettingPresenter settingPresenter) {
        super(2);
