...
final class SettingFragment$initUI$2$1 extends Lambda implements Function1<SettingItemAdapter.SettingListItem, Unit> {
    final /* synthetic */ SettingFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SettingFragment$initUI$2$1(SettingFragment settingFragment) {
        super(1);
