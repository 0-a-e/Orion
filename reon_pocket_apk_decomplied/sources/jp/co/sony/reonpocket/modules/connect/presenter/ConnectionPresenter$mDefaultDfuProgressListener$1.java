...
public final class ConnectionPresenter$mDefaultDfuProgressListener$1 extends DfuProgressListenerAdapter {
    ...
    ConnectionPresenter$mDefaultDfuProgressListener$1(ConnectionPresenter connectionPresenter) {
    ...
    public void onProgressChanged(String str, int i, float f, float f2, int i2, int i3) {
        ...
        if (i == 100) {
            ...
            this.this$0.setDfuState(ConnectionPresenter.DfuState.DFU_FINISHED);
        }
    }

    public void onDeviceDisconnecting(String str) {
        ConnectionPresenter.DfuState dfuState;
        ConnectionViewInput access$getAView$p = this.this$0.aView;
        if (access$getAView$p != null) {
            access$getAView$p.showDfuDisconnect();
        }
        ConnectionPresenter connectionPresenter = this.this$0;
        if (connectionPresenter.mIsDfuSuccess) {
            dfuState = ConnectionPresenter.DfuState.DFU_FINISHED;
        } else {
            dfuState = ConnectionPresenter.DfuState.DFU_FAILED;
        }
        connectionPresenter.setDfuState(dfuState);
    }
    ...
    public void onDfuProcessStarting(String str) {
        ...
        this.this$0.setDfuState(ConnectionPresenter.DfuState.DFU_GOING);
    }
    ...
    public void onError(String str, int i, int i2, String str2) {
        ...
        this.this$0.setDfuState(ConnectionPresenter.DfuState.DFU_FAILED);
