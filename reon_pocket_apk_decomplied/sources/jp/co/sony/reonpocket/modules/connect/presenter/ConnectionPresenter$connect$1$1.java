...
final class ConnectionPresenter$connect$1$1 extends Lambda implements Function2<BleConnStatusCode, ArrayList<String>, Unit> {
    final /* synthetic */ ConnectionPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConnectionPresenter$connect$1$1(ConnectionPresenter connectionPresenter) {
        super(2);
