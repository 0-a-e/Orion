...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, d2 = {"jp/co/sony/reonpocket/modules/connect/view/ConnectionActivity$showNotification$2", "Ljp/co/sony/reonpocket/view/fragment/BaseDialogFragment$DialogFragmentLifecycleListener;", "onViewCreated", "", "aView", "Landroid/view/View;", "app_prodRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* compiled from: ConnectionActivity.kt */
public final class ConnectionActivity$showNotification$2 implements BaseDialogFragment.DialogFragmentLifecycleListener {
    ...
    ConnectionActivity$showNotification$2(String str, String str2, String str3, ConnectionActivity connectionActivity, Bitmap bitmap) {
        this.$aSubtitle = str;
    ...
    public void onViewCreated(View view) {
        ...
        if (str != null) {
            ...
            if (customFontTextView3 != null) {
                customFontTextView3.setOnClickListener(new ConnectionActivity$showNotification$2$$ExternalSyntheticLambda0(connectionActivity));
                unit = Unit.INSTANCE;
            }
            if (unit == null) {
