...
final class PairingPresenter$connectDFU$1 extends Lambda implements Function2<BleConnStatusCode, ArrayList<String>, Unit> {
    final /* synthetic */ PairingPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PairingPresenter$connectDFU$1(PairingPresenter pairingPresenter) {
        super(2);
