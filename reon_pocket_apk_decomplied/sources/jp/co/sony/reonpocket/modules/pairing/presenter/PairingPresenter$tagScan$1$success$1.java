...
final class PairingPresenter$tagScan$1$success$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $deviceName;
    final /* synthetic */ TagDataEntity $tagDataEntity;
    final /* synthetic */ PairingPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PairingPresenter$tagScan$1$success$1(PairingPresenter pairingPresenter, TagDataEntity tagDataEntity, String str) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (bdAddress != null) {
            ...
            pairingPresenter.mTagInfoInteractor.saveTagBDAddress(pairingPresenter.aContext, bdAddress);
        }
