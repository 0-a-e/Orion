...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, d2 = {"jp/co/sony/reonpocket/modules/initialize/view/InitUserInfoFragment$showPickerDialog$1", "Ljp/co/sony/reonpocket/view/fragment/BaseDialogFragment$DialogFragmentLifecycleListener;", "onViewCreated", "", "aView", "Landroid/view/View;", "app_prodRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* compiled from: InitUserInfoFragment.kt */
public final class InitUserInfoFragment$showPickerDialog$1 implements BaseDialogFragment.DialogFragmentLifecycleListener {
    ...
    InitUserInfoFragment$showPickerDialog$1(int i, int i2, InitUserInfoFragment initUserInfoFragment, Ref.ObjectRef<Integer> objectRef) {
        this.$minValue = i;
        this.$aViewId = i2;
    ...
    public void onViewCreated(View view) {
        ...
        if (i == 2) {
            ...
            numberPicker.setOnValueChangedListener(new InitUserInfoFragment$showPickerDialog$1$$ExternalSyntheticLambda0(this.this$0));
        } else if (i == 3) {
            ...
            numberPicker.setOnValueChangedListener(new InitUserInfoFragment$showPickerDialog$1$$ExternalSyntheticLambda1(this.this$0));
        } else if (i == 4) {
            ...
            numberPicker.setOnValueChangedListener(new InitUserInfoFragment$showPickerDialog$1$$ExternalSyntheticLambda2(this.this$0));
        } else if (i == 5) {
            ...
            numberPicker.setOnValueChangedListener(new InitUserInfoFragment$showPickerDialog$1$$ExternalSyntheticLambda3(this.this$0));
        }
        ...
        initUserInfoFragment.changeNumberPickerDividerColor(numberPicker, initUserInfoFragment.getResources().getColor(R.color.colorTransparent));
    }

    /* access modifiers changed from: private */
    public static final void onViewCreated$lambda$0(InitUserInfoFragment initUserInfoFragment, NumberPicker numberPicker, int i, int i2) {
        Intrinsics.checkNotNullParameter(initUserInfoFragment, "this$0");
        initUserInfoFragment.mTempAgeSelectedValue = i2;
        initUserInfoFragment.mLastAgeSelectedValue = initUserInfoFragment.mTempAgeSelectedValue;
    }

    /* access modifiers changed from: private */
    public static final void onViewCreated$lambda$1(InitUserInfoFragment initUserInfoFragment, NumberPicker numberPicker, int i, int i2) {
        Intrinsics.checkNotNullParameter(initUserInfoFragment, "this$0");
        initUserInfoFragment.mTempHeightSelectedValue = i2;
        initUserInfoFragment.mLastHeightSelectedValue = initUserInfoFragment.mTempHeightSelectedValue;
    }

    /* access modifiers changed from: private */
    public static final void onViewCreated$lambda$2(InitUserInfoFragment initUserInfoFragment, NumberPicker numberPicker, int i, int i2) {
        Intrinsics.checkNotNullParameter(initUserInfoFragment, "this$0");
        initUserInfoFragment.mTempWeightSelectedValue = i2;
        initUserInfoFragment.mLastWeightSelectedValue = initUserInfoFragment.mTempWeightSelectedValue;
    }

    /* access modifiers changed from: private */
    public static final void onViewCreated$lambda$3(InitUserInfoFragment initUserInfoFragment, NumberPicker numberPicker, int i, int i2) {
        Intrinsics.checkNotNullParameter(initUserInfoFragment, "this$0");
        initUserInfoFragment.mTempAddressSelectedValue = i2;
        initUserInfoFragment.mLastAddressSelectedValue = initUserInfoFragment.mTempAddressSelectedValue;
    }
}
