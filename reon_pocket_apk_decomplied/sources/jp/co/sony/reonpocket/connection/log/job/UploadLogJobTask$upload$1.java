...
public final class UploadLogJobTask$upload$1 implements TransferListener {
    ...
    UploadLogJobTask$upload$1(String str, File file) {
        this.$aFileName = str;
        this.$aFile = file;
    }
