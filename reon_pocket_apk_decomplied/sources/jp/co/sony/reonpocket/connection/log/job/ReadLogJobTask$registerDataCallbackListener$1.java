...
final class ReadLogJobTask$registerDataCallbackListener$1 extends Lambda implements Function1<BleDataEntity, Unit> {
    final /* synthetic */ ReadLogJobTask this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ReadLogJobTask$registerDataCallbackListener$1(ReadLogJobTask readLogJobTask) {
        super(1);
