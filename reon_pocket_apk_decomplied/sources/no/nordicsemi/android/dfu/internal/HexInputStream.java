...
public class HexInputStream extends FilterInputStream {
    ...
    private int calculateBinSize(int r11) throws no.nordicsemi.android.dfu.internal.exception.HexFileValidationException, java.io.IOException {
        /*
            r10 = this;
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockFinish
        jadx.core.utils.exceptions.JadxRuntimeException: Dominance frontier not set for block: B:3:0x000b
    ...
    public synchronized void mark(int r1) {
        /*
            r0 = this;
            monitor-enter(r0)
            java.io.InputStream r1 = r0.in     // Catch:{ IOException -> 0x000e }
            int r1 = r1.available()     // Catch:{ IOException -> 0x000e }
            super.mark(r1)     // Catch:{ IOException -> 0x000e }
            goto L_0x000e
        L_0x000b:
            r1 = move-exception
