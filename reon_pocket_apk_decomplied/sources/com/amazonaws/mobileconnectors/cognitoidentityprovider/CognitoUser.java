...
public class CognitoUser {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        hashMap.put(TransferTable.COLUMN_TYPE, CognitoServiceConstants.CHLG_TYPE_SOFTWARE_TOKEN_MFA);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:13:0x0098 A[Catch:{ Exception -> 0x00f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00c7 A[Catch:{ Exception -> 0x00f2 }] */
    ...
    private com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserSession readCachedTokens() {
        /*
            ...
            r4.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r5 = r9.clientId     // Catch:{ Exception -> 0x00f2 }
            r4.append(r5)     // Catch:{ Exception -> 0x00f2 }
            r4.append(r0)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r5 = r9.userId     // Catch:{ Exception -> 0x00f2 }
            r4.append(r5)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r5 = ".idToken"
            r4.append(r5)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r4 = r4.toString()     // Catch:{ Exception -> 0x00f2 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2 }
            r5.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r6 = r9.clientId     // Catch:{ Exception -> 0x00f2 }
            r5.append(r6)     // Catch:{ Exception -> 0x00f2 }
            r5.append(r0)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r6 = r9.userId     // Catch:{ Exception -> 0x00f2 }
            r5.append(r6)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r6 = ".accessToken"
            r5.append(r6)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r5 = r5.toString()     // Catch:{ Exception -> 0x00f2 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2 }
            r6.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r1 = r9.clientId     // Catch:{ Exception -> 0x00f2 }
            r6.append(r1)     // Catch:{ Exception -> 0x00f2 }
            r6.append(r0)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r0 = r9.userId     // Catch:{ Exception -> 0x00f2 }
            r6.append(r0)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r0 = ".refreshToken"
            r6.append(r0)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r0 = r6.toString()     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            boolean r1 = r1.contains(r4)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r6 = " is null."
            java.lang.String r7 = "IdToken for "
            if (r1 == 0) goto L_0x008d
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r1 = r1.get(r4)     // Catch:{ Exception -> 0x00f2 }
            if (r1 == 0) goto L_0x0079
            com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoIdToken r4 = new com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoIdToken     // Catch:{ Exception -> 0x00f2 }
            r4.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            goto L_0x008e
        L_0x0079:
            com.amazonaws.logging.Log r1 = LOGGER     // Catch:{ Exception -> 0x00f2 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2 }
            r8.<init>(r7)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r4)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r6)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r4 = r8.toString()     // Catch:{ Exception -> 0x00f2 }
            r1.warn(r4)     // Catch:{ Exception -> 0x00f2 }
        L_0x008d:
            r4 = r3
        L_0x008e:
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            boolean r1 = r1.contains(r5)     // Catch:{ Exception -> 0x00f2 }
            if (r1 == 0) goto L_0x00bc
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r1 = r1.get(r5)     // Catch:{ Exception -> 0x00f2 }
            if (r1 == 0) goto L_0x00a8
            com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoAccessToken r5 = new com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoAccessToken     // Catch:{ Exception -> 0x00f2 }
            r5.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            goto L_0x00bd
        L_0x00a8:
            com.amazonaws.logging.Log r1 = LOGGER     // Catch:{ Exception -> 0x00f2 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2 }
            r8.<init>(r7)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r5)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r6)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r5 = r8.toString()     // Catch:{ Exception -> 0x00f2 }
            r1.warn(r5)     // Catch:{ Exception -> 0x00f2 }
        L_0x00bc:
            r5 = r3
        L_0x00bd:
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            boolean r1 = r1.contains(r0)     // Catch:{ Exception -> 0x00f2 }
            if (r1 == 0) goto L_0x00eb
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserPool r1 = r9.pool     // Catch:{ Exception -> 0x00f2 }
            com.amazonaws.internal.keyvaluestore.AWSKeyValueStore r1 = r1.awsKeyValueStore     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r1 = r1.get(r0)     // Catch:{ Exception -> 0x00f2 }
            if (r1 == 0) goto L_0x00d7
            com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoRefreshToken r3 = new com.amazonaws.mobileconnectors.cognitoidentityprovider.tokens.CognitoRefreshToken     // Catch:{ Exception -> 0x00f2 }
            r3.<init>(r1)     // Catch:{ Exception -> 0x00f2 }
            goto L_0x00eb
        L_0x00d7:
            com.amazonaws.logging.Log r1 = LOGGER     // Catch:{ Exception -> 0x00f2 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2 }
            r8.<init>(r7)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r0)     // Catch:{ Exception -> 0x00f2 }
            r8.append(r6)     // Catch:{ Exception -> 0x00f2 }
            java.lang.String r0 = r8.toString()     // Catch:{ Exception -> 0x00f2 }
            r1.warn(r0)     // Catch:{ Exception -> 0x00f2 }
        L_0x00eb:
            com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserSession r0 = new com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUserSession     // Catch:{ Exception -> 0x00f2 }
            r0.<init>(r4, r5, r3)     // Catch:{ Exception -> 0x00f2 }
            r2 = r0
            goto L_0x00fa
        L_0x00f2:
            r0 = move-exception
        ...
        static {
            ...
            try {
                if (Build.VERSION.SDK_INT >= 26) {
                    SECURE_RANDOM = Trace$$ExternalSyntheticApiModelOutline0.m();
                } else {
