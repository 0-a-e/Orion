    ...
    class UploadTaskProgressListener implements ProgressListener {
        ...
        public synchronized void onProgressChanged(int r8, long r9) {
            /*
                ...
                java.util.Map<java.lang.Integer, com.amazonaws.mobileconnectors.s3.transferutility.UploadTask$UploadPartTaskMetadata> r0 = r0.uploadPartTasks     // Catch:{ all -> 0x0073 }
                ...
                com.amazonaws.logging.Log r8 = com.amazonaws.mobileconnectors.s3.transferutility.UploadTask.LOGGER     // Catch:{ all -> 0x0073 }
                java.lang.String r9 = "Update received for unknown part. Ignoring."
                r8.info(r9)     // Catch:{ all -> 0x0073 }
                monitor-exit(r7)
                return
            L_0x001c:
                r8.bytesTransferredSoFar = r9     // Catch:{ all -> 0x0073 }
                long r8 = r7.bytesAlreadyTransferred     // Catch:{ all -> 0x0073 }
                ...
                java.util.Map<java.lang.Integer, com.amazonaws.mobileconnectors.s3.transferutility.UploadTask$UploadPartTaskMetadata> r10 = r10.uploadPartTasks     // Catch:{ all -> 0x0073 }
            ...
            L_0x002c:
                ...
                long r0 = r0.bytesTransferredSoFar     // Catch:{ all -> 0x0073 }
                long r8 = r8 + r0
                goto L_0x002c
            L_0x0042:
                long r0 = r7.prevTotalBytesTransferredOfAllParts     // Catch:{ all -> 0x0073 }
                int r10 = (r8 > r0 ? 1 : (r8 == r0 ? 0 : -1))
                if (r10 <= 0) goto L_0x0071
                com.amazonaws.mobileconnectors.s3.transferutility.UploadTask r10 = com.amazonaws.mobileconnectors.s3.transferutility.UploadTask.this     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.TransferRecord r10 = r10.upload     // Catch:{ all -> 0x0073 }
                long r0 = r10.bytesTotal     // Catch:{ all -> 0x0073 }
                int r10 = (r8 > r0 ? 1 : (r8 == r0 ? 0 : -1))
                if (r10 > 0) goto L_0x0071
                com.amazonaws.mobileconnectors.s3.transferutility.UploadTask r10 = com.amazonaws.mobileconnectors.s3.transferutility.UploadTask.this     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.TransferStatusUpdater r0 = r10.updater     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.UploadTask r10 = com.amazonaws.mobileconnectors.s3.transferutility.UploadTask.this     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.TransferRecord r10 = r10.upload     // Catch:{ all -> 0x0073 }
                int r1 = r10.id     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.UploadTask r10 = com.amazonaws.mobileconnectors.s3.transferutility.UploadTask.this     // Catch:{ all -> 0x0073 }
                com.amazonaws.mobileconnectors.s3.transferutility.TransferRecord r10 = r10.upload     // Catch:{ all -> 0x0073 }
                long r4 = r10.bytesTotal     // Catch:{ all -> 0x0073 }
                r6 = 1
                r2 = r8
                r0.updateProgress(r1, r2, r4, r6)     // Catch:{ all -> 0x0073 }
                r7.prevTotalBytesTransferredOfAllParts = r8     // Catch:{ all -> 0x0073 }
            L_0x0071:
                monitor-exit(r7)
                return
            L_0x0073:
