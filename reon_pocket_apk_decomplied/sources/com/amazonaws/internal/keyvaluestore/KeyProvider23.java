    ...
    public synchronized Key generateKey(String str) throws KeyNotGeneratedException {
        ...
        try {
            ...
            if (!instance.containsAlias(str)) {
                ...
                instance2.init(new KeyGenParameterSpec.Builder(str, 3).setBlockModes(new String[]{CodePackage.GCM}).setEncryptionPaddings(new String[]{"NoPadding"}).setKeySize(256).setRandomizedEncryptionRequired(false).build());
