...
public class ServiceUtils {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x008b A[ADDED_TO_REGION] */
    ...
    public static void downloadObjectToFile(com.amazonaws.services.s3.model.S3Object r5, java.io.File r6, boolean r7, boolean r8) {
        ...
        L_0x0011:
            r1 = 0
            java.io.BufferedOutputStream r2 = new java.io.BufferedOutputStream     // Catch:{ IOException -> 0x00bc }
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ IOException -> 0x00bc }
            r3.<init>(r6, r8)     // Catch:{ IOException -> 0x00bc }
            r2.<init>(r3)     // Catch:{ IOException -> 0x00bc }
            r8 = 10240(0x2800, float:1.4349E-41)
            byte[] r8 = new byte[r8]     // Catch:{ IOException -> 0x00b7, all -> 0x00b4 }
        L_0x0020:
            com.amazonaws.services.s3.model.S3ObjectInputStream r3 = r5.getObjectContent()     // Catch:{ IOException -> 0x00b7, all -> 0x00b4 }
            int r3 = r3.read(r8)     // Catch:{ IOException -> 0x00b7, all -> 0x00b4 }
            r4 = -1
            if (r3 <= r4) goto L_0x0030
            r4 = 0
            r2.write(r8, r4, r3)     // Catch:{ IOException -> 0x00b7, all -> 0x00b4 }
            goto L_0x0020
        L_0x0030:
        ...
        L_0x0046:
            ...
            byte[] r8 = com.amazonaws.util.Md5Utils.computeMD5Hash((java.io.InputStream) r8)     // Catch:{ Exception -> 0x006e }
        ...
        L_0x00bc:
            r6 = move-exception
        L_0x00bd:
            com.amazonaws.services.s3.model.S3ObjectInputStream r7 = r5.getObjectContent()     // Catch:{ all -> 0x00ba }
            r7.abort()     // Catch:{ all -> 0x00ba }
            com.amazonaws.AmazonClientException r7 = new com.amazonaws.AmazonClientException     // Catch:{ all -> 0x00ba }
            ...
            java.lang.String r2 = r6.getMessage()     // Catch:{ all -> 0x00ba }
            r8.append(r2)     // Catch:{ all -> 0x00ba }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00ba }
            r7.<init>(r8, r6)     // Catch:{ all -> 0x00ba }
        ...
        L_0x00e3:
            ...
            r7.debug(r0)
        L_0x00e8:
            com.amazonaws.services.s3.model.S3ObjectInputStream r5 = r5.getObjectContent()     // Catch:{ Exception -> 0x00f0 }
