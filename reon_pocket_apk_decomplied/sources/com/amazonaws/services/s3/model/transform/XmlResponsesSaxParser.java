...
public class XmlResponsesSaxParser {
    ...
    public static class ListBucketHandler extends AbstractHandler {
        ...
        public void doEndElement(String str, String str2, String str3) {
            ...
            if (atTopLevel()) {
                ...
                if (str2.equals("Name")) {
                    ...
                    if (XmlResponsesSaxParser.log.isDebugEnabled()) {
                        ...
                        access$000.debug("Examining listing for bucket: " + this.objectListing.getBucketName());
                    }
            ...
            } else if (in("ListBucketResult", "CommonPrefixes") && str2.equals(TextFieldImplKt.PrefixId)) {
