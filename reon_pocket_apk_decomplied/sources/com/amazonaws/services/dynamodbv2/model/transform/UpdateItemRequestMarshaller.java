        ...
        if (updateItemRequest != null) {
            ...
            try {
                ...
                if (updateItemRequest.getAttributeUpdates() != null) {
                    ...
                    jsonWriter.beginObject();
                    for (Map.Entry next2 : attributeUpdates.entrySet()) {
                        AttributeValueUpdate attributeValueUpdate = (AttributeValueUpdate) next2.getValue();
                        if (attributeValueUpdate != null) {
                            jsonWriter.name((String) next2.getKey());
                            AttributeValueUpdateJsonMarshaller.getInstance().marshall(attributeValueUpdate, jsonWriter);
                        }
                    }
                    jsonWriter.endObject();
                }
                if (updateItemRequest.getExpected() != null) {
                    ...
                    jsonWriter.beginObject();
                    for (Map.Entry next3 : expected.entrySet()) {
                        ExpectedAttributeValue expectedAttributeValue = (ExpectedAttributeValue) next3.getValue();
