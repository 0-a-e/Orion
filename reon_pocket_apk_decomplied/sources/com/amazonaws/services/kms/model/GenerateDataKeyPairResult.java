...
public class GenerateDataKeyPairResult implements Serializable {
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((((i + 31) * 31) + (getPrivateKeyPlaintext() == null ? 0 : getPrivateKeyPlaintext().hashCode())) * 31) + (getPublicKey() == null ? 0 : getPublicKey().hashCode())) * 31) + (getKeyId() == null ? 0 : getKeyId().hashCode())) * 31) + (getKeyPairSpec() == null ? 0 : getKeyPairSpec().hashCode())) * 31;
        if (getCiphertextForRecipient() != null) {
            i2 = getCiphertextForRecipient().hashCode();
        }
        return hashCode + i2;
    }
