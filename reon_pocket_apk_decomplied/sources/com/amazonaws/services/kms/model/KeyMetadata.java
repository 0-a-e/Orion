...
public class KeyMetadata implements Serializable {
    ...
    public int hashCode() {
        ...
        if (getKeyAgreementAlgorithms() == null) {
            ...
            i = getKeyAgreementAlgorithms().hashCode();
        }
        int hashCode2 = (((hashCode + i) * 31) + (getMultiRegion() == null ? 0 : getMultiRegion().hashCode())) * 31;
        if (getMultiRegionConfiguration() == null) {
            i2 = 0;
        } else {
            i2 = getMultiRegionConfiguration().hashCode();
        }
        int i5 = (hashCode2 + i2) * 31;
        if (getPendingDeletionWindowInDays() == null) {
            i3 = 0;
        } else {
            i3 = getPendingDeletionWindowInDays().hashCode();
        }
        int hashCode3 = (((i5 + i3) * 31) + (getMacAlgorithms() == null ? 0 : getMacAlgorithms().hashCode())) * 31;
        if (getXksKeyConfiguration() != null) {
            i4 = getXksKeyConfiguration().hashCode();
        }
        return hashCode3 + i4;
    }
