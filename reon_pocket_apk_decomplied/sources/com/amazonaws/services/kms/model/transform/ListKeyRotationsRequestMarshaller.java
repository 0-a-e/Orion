...
public class ListKeyRotationsRequestMarshaller implements Marshaller<Request<ListKeyRotationsRequest>, ListKeyRotationsRequest> {
    public Request<ListKeyRotationsRequest> marshall(ListKeyRotationsRequest listKeyRotationsRequest) {
        if (listKeyRotationsRequest != null) {
            DefaultRequest defaultRequest = new DefaultRequest(listKeyRotationsRequest, "AWSKMS");
            defaultRequest.addHeader("X-Amz-Target", "TrentService.ListKeyRotations");
