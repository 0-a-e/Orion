...
public class CustomKeyStoresListEntry implements Serializable {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode + i) * 31) + (getConnectionState() == null ? 0 : getConnectionState().hashCode())) * 31) + (getConnectionErrorCode() == null ? 0 : getConnectionErrorCode().hashCode())) * 31) + (getCreationDate() == null ? 0 : getCreationDate().hashCode())) * 31) + (getCustomKeyStoreType() == null ? 0 : getCustomKeyStoreType().hashCode())) * 31;
        if (getXksProxyConfiguration() != null) {
            i2 = getXksProxyConfiguration().hashCode();
        }
        return hashCode2 + i2;
    }
