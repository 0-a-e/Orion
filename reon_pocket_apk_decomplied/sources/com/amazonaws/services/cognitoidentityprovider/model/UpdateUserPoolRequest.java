...
public class UpdateUserPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        int i7;
        int i8 = 0;
        int hashCode = ((((((((getUserPoolId() == null ? 0 : getUserPoolId().hashCode()) + 31) * 31) + (getPolicies() == null ? 0 : getPolicies().hashCode())) * 31) + (getDeletionProtection() == null ? 0 : getDeletionProtection().hashCode())) * 31) + (getLambdaConfig() == null ? 0 : getLambdaConfig().hashCode())) * 31;
        if (getAutoVerifiedAttributes() == null) {
            i = 0;
        } else {
