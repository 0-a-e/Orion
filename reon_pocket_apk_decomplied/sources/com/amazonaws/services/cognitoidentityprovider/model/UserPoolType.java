...
public class UserPoolType implements Serializable {
    ...
    public int hashCode() {
        ...
        int i10;
        int i11 = 0;
        int hashCode = ((((((((((((((((((getId() == null ? 0 : getId().hashCode()) + 31) * 31) + (getName() == null ? 0 : getName().hashCode())) * 31) + (getPolicies() == null ? 0 : getPolicies().hashCode())) * 31) + (getDeletionProtection() == null ? 0 : getDeletionProtection().hashCode())) * 31) + (getLambdaConfig() == null ? 0 : getLambdaConfig().hashCode())) * 31) + (getStatus() == null ? 0 : getStatus().hashCode())) * 31) + (getLastModifiedDate() == null ? 0 : getLastModifiedDate().hashCode())) * 31) + (getCreationDate() == null ? 0 : getCreationDate().hashCode())) * 31) + (getSchemaAttributes() == null ? 0 : getSchemaAttributes().hashCode())) * 31;
        if (getAutoVerifiedAttributes() == null) {
            i = 0;
        } else {
        ...
        if (getUserAttributeUpdateSettings() == null) {
            ...
            i7 = getUserAttributeUpdateSettings().hashCode();
        }
        int hashCode3 = (((((i16 + i7) * 31) + (getMfaConfiguration() == null ? 0 : getMfaConfiguration().hashCode())) * 31) + (getDeviceConfiguration() == null ? 0 : getDeviceConfiguration().hashCode())) * 31;
        if (getEstimatedNumberOfUsers() == null) {
            i8 = 0;
        } else {
            i8 = getEstimatedNumberOfUsers().hashCode();
        }
        int hashCode4 = (((((((hashCode3 + i8) * 31) + (getEmailConfiguration() == null ? 0 : getEmailConfiguration().hashCode())) * 31) + (getSmsConfiguration() == null ? 0 : getSmsConfiguration().hashCode())) * 31) + (getUserPoolTags() == null ? 0 : getUserPoolTags().hashCode())) * 31;
        if (getSmsConfigurationFailure() == null) {
            i9 = 0;
        } else {
            i9 = getSmsConfigurationFailure().hashCode();
        }
        int i17 = (hashCode4 + i9) * 31;
        if (getEmailConfigurationFailure() == null) {
            i10 = 0;
        } else {
            i10 = getEmailConfigurationFailure().hashCode();
        }
        int hashCode5 = (((((((((((((i17 + i10) * 31) + (getDomain() == null ? 0 : getDomain().hashCode())) * 31) + (getCustomDomain() == null ? 0 : getCustomDomain().hashCode())) * 31) + (getAdminCreateUserConfig() == null ? 0 : getAdminCreateUserConfig().hashCode())) * 31) + (getUserPoolAddOns() == null ? 0 : getUserPoolAddOns().hashCode())) * 31) + (getUsernameConfiguration() == null ? 0 : getUsernameConfiguration().hashCode())) * 31) + (getArn() == null ? 0 : getArn().hashCode())) * 31;
        if (getAccountRecoverySetting() != null) {
            i11 = getAccountRecoverySetting().hashCode();
        }
