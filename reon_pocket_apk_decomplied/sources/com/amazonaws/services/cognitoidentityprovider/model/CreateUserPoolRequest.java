...
public class CreateUserPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        int i7;
        int i8 = 0;
        int hashCode = ((((((((getPoolName() == null ? 0 : getPoolName().hashCode()) + 31) * 31) + (getPolicies() == null ? 0 : getPolicies().hashCode())) * 31) + (getDeletionProtection() == null ? 0 : getDeletionProtection().hashCode())) * 31) + (getLambdaConfig() == null ? 0 : getLambdaConfig().hashCode())) * 31;
        if (getAutoVerifiedAttributes() == null) {
            i = 0;
        } else {
