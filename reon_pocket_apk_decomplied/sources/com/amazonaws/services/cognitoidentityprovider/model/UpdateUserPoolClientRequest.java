...
public class UpdateUserPoolClientRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        int hashCode3 = (((i8 + i4) * 31) + (getEnableTokenRevocation() == null ? 0 : getEnableTokenRevocation().hashCode())) * 31;
        if (getEnablePropagateAdditionalUserContextData() == null) {
            i5 = 0;
        } else {
            i5 = getEnablePropagateAdditionalUserContextData().hashCode();
        }
        int i9 = (hashCode3 + i5) * 31;
        if (getAuthSessionValidity() != null) {
            i6 = getAuthSessionValidity().hashCode();
        }
        return i9 + i6;
    }
