...
public class STSAssumeRoleSessionCredentialsProvider implements AWSCredentialsProvider {
    ...
    private boolean needsNewSession() {
        if (this.sessionCredentials != null && this.sessionCredentialsExpiration.getTime() - System.currentTimeMillis() >= LaunchApplicationNotificationService.BEACON_SCAN_CYCLE_MS) {
            return false;
        }
        return true;
    }
