...
abstract class zzw {
    ...
    static Boolean zzg(long j, zzeq zzeq) {
        try {
            return zzj(new BigDecimal(j), zzeq, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
    ...
    static Boolean zzi(String str, zzeq zzeq) {
        ...
        try {
            return zzj(new BigDecimal(str), zzeq, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
