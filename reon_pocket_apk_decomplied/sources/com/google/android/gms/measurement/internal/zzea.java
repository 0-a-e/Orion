...
public final class zzea {
    ...
    static {
        ...
        zzb = zzb("measurement.monitoring.sample_period_millis", valueOf, valueOf, zzbf.zza);
        zzc = zzb("measurement.config.cache_time", valueOf, 3600000L, zzbq.zza);
        Integer valueOf2 = Integer.valueOf(Constants.MAXIMUM_UPLOAD_PARTS);
        zzm = zzb("measurement.upload.max_conversions_per_day", valueOf2, valueOf2, zzax.zza);
        Long valueOf3 = Long.valueOf(LaunchApplicationNotificationService.BEACON_SCAN_CYCLE_MS);
        zzw = zzb("measurement.alarm_manager.minimum_interval", valueOf3, valueOf3, zzbi.zza);
        zzx = zzb("measurement.upload.stale_data_deletion_interval", valueOf, valueOf, zzbj.zza);
        Long valueOf4 = Long.valueOf(CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS);
        zzA = zzb("measurement.upload.retry_time", valueOf4, valueOf4, zzbm.zza);
