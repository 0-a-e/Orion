...
public final class zznq implements zznp {
    ...
    static {
        ...
        zzc = zzhr.zza("measurement.config.cache_time", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzl = zzhr.zza("measurement.alarm_manager.minimum_interval", LaunchApplicationNotificationService.BEACON_SCAN_CYCLE_MS);
        zzm = zzhr.zza("measurement.upload.minimum_delay", 500);
        zzn = zzhr.zza("measurement.monitoring.sample_period_millis", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzt = zzhr.zza("measurement.upload.stale_data_deletion_interval", CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzJ = zzhr.zza("measurement.upload.retry_time", CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS);
