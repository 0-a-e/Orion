...
public abstract class zzjd implements Iterable<Byte>, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", new Object[]{Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzc()), zzc() <= 50 ? zzmf.zza(this) : String.valueOf(zzmf.zza(zze(0, 47))).concat("...")});
    }
