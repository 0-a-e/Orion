...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        httpURLConnection.setRequestProperty(HttpHeader.USER_AGENT, String.format("datatransport/%s android/", new Object[]{BuildConfig.VERSION_NAME}));
        ...
        try {
            ...
            try {
                ...
                if (responseCode == 302 || responseCode == 301 || responseCode == 307) {
                    return new HttpResponse(responseCode, new URL(httpURLConnection.getHeaderField(HttpHeader.LOCATION)), 0);
                }
                if (responseCode != 200) {
