...
public class FirebaseRemoteConfig {
    ...
    public /* synthetic */ Task m6970lambda$fetchAndActivate$1$comgooglefirebaseremoteconfigFirebaseRemoteConfig(Void voidR) throws Exception {
        return activate();
    }
    ...
    public /* synthetic */ Task m6969lambda$activate$2$comgooglefirebaseremoteconfigFirebaseRemoteConfig(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> fetch() {
        return this.fetchHandler.fetch().onSuccessTask(new FirebaseRemoteConfig$$ExternalSyntheticLambda9());
    }

    public Task<Void> fetch(long j) {
        return this.fetchHandler.fetch(j).onSuccessTask(new FirebaseRemoteConfig$$ExternalSyntheticLambda3());
    }
    ...
    public /* synthetic */ Void m6972lambda$setConfigSettingsAsync$5$comgooglefirebaseremoteconfigFirebaseRemoteConfig(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public /* synthetic */ Void m6971lambda$reset$6$comgooglefirebaseremoteconfigFirebaseRemoteConfig() throws Exception {
    ...
    private Task<Void> setDefaultsWithStringsMapAsync(Map<String, String> map) {
        try {
            return this.defaultConfigsCache.put(ConfigContainer.newBuilder().replaceConfigsWith(map).build()).onSuccessTask(new FirebaseRemoteConfig$$ExternalSyntheticLambda1());
