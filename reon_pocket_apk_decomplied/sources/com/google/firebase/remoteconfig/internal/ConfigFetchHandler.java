...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> m6975lambda$fetch$0$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task<ConfigContainer> task, long j) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda2(this, id, token, date));
        }
    ...
    public /* synthetic */ Task m6976lambda$fetchIfCacheExpiredAndNotThrottled$1$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task task, Task task2, Date date, Task task3) throws Exception {
    ...
    public /* synthetic */ Task m6977lambda$fetchIfCacheExpiredAndNotThrottled$2$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Date date, Task task) throws Exception {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new ConfigFetchHandler$$ExternalSyntheticLambda1(fetchFromBackend));
