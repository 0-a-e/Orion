...
public final class CommonNotificationBuilder {
        ...
        try {
            if (context.getPackageManager().getApplicationInfo(context.getPackageName(), 0).targetSdkVersion >= 26) {
                ...
                if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                    ...
                    notificationManager.createNotificationChannel(Trace$$ExternalSyntheticApiModelOutline0.m(FCM_FALLBACK_NOTIFICATION_CHANNEL, (CharSequence) str2, 3));
                }
    ...
    private static boolean isValidIcon(Resources resources, int i) {
        ...
        try {
            if (!Trace$$ExternalSyntheticApiModelOutline0.m((Object) resources.getDrawable(i, (Resources.Theme) null))) {
                return true;
            }
